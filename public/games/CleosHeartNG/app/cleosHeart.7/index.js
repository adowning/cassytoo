...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(t, e, o) {
...
$jscomp.polyfill("Promise", (function(t) {
    ...
    if (t && !$jscomp.FORCE_POLYFILL_PROMISE)
        return t;
    ...
    r.prototype.settle_ = function(t, e) {
        if (0 != this.state_)
            throw Error("Cannot settle(" + t + ", " + e + "): Promise already settled in state" + this.state_);
        this.state_ = t,
        this.result_ = e,
    ...
    r.prototype.executeOnSettledCallbacks_ = function() {
        if (null != this.onSettledCallbacks_) {
            for (var t = 0; t < this.onSettledCallbacks_.length; ++t)
                i.asyncExecute(this.onSettledCallbacks_[t]);
    ...
    r.prototype.then = function(t, e) {
        ...
        return this.callWhenSettled_(o(t, n), o(e, i)),
        s
    }
    ,
    ...
    r.race = function(t) {
        return new r((function(e, n) {
            for (var r = $jscomp.makeIterator(t), i = r.next(); !i.done; i = r.next())
                o(i.value).callWhenSettled_(e, n)
        }
        ))
    }
    ,
    r.all = function(t) {
        ...
        return n.done ? o([]) : new r((function(t, r) {
            ...
            do {
                s.push(void 0),
                c++,
                o(n.value).callWhenSettled_(i(s.length - 1), r),
                n = e.next()
            } while (!n.done)
        }
        ))
...
$jscomp.generator.Context.prototype.yieldAll = function(t, e) {
    ...
    if ($jscomp.generator.ensureIteratorResultIsObject_(o),
    !o.done)
        return this.yieldAllIterator_ = t,
        this.yield(o.value, e);
    this.yieldResult = o.value,
    this.nextAddress = e
}
,
...
$jscomp.generator.Context.prototype.enterFinallyBlock = function(t, e, o) {
    o ? this.finallyContexts_[o] = this.abruptCompletion_ : this.finallyContexts_ = [this.abruptCompletion_],
    this.catchAddress_ = t || 0,
    this.finallyAddress_ = e || 0
}
,
$jscomp.generator.Context.prototype.leaveFinallyBlock = function(t, e) {
    if (e = this.finallyContexts_.splice(e || 0)[0],
    e = this.abruptCompletion_ = this.abruptCompletion_ || e) {
        if (e.isException)
            return this.jumpToErrorHandler_();
        null != e.jumpTo && this.finallyAddress_ < e.jumpTo ? (this.nextAddress = e.jumpTo,
...
$jscomp.generator.Engine_.prototype.next_ = function(t) {
    return this.context_.start_(),
    this.context_.yieldAllIterator_ ? this.yieldAllStep_(this.context_.yieldAllIterator_.next, t, this.context_.next_) : (this.context_.next_(t),
    this.nextStep_())
}
,
$jscomp.generator.Engine_.prototype.return_ = function(t) {
    ...
    , t, this.context_.return) : (this.context_.return(t),
    this.nextStep_())
}
,
$jscomp.generator.Engine_.prototype.throw_ = function(t) {
    return this.context_.start_(),
    this.context_.yieldAllIterator_ ? this.yieldAllStep_(this.context_.yieldAllIterator_.throw, t, this.context_.next_) : (this.context_.throw_(t),
    this.nextStep_())
}
,
$jscomp.generator.Engine_.prototype.yieldAllStep_ = function(t, e, o) {
    try {
        ...
        if ($jscomp.generator.ensureIteratorResultIsObject_(n),
        !n.done)
...
$jscomp.generator.Engine_.prototype.nextStep_ = function() {
    ...
    if (this.context_.stop_(),
    this.context_.abruptCompletion_) {
        if (t = this.context_.abruptCompletion_,
...
$jscomp.generator.createGenerator = function(t, e) {
    return e = new $jscomp.generator.Generator_(new $jscomp.generator.Engine_(e)),
    $jscomp.setPrototypeOf && $jscomp.setPrototypeOf(e, t.prototype),
    e
}
,
...
function(t) {
    function e(e) {
        for (var o, n, i = e[0], s = e[1], c = 0, a = []; c < i.length; c++)
            n = i[c],
            Object.prototype.hasOwnProperty.call(r, n) && r[n] && a.push(r[n][0]),
            r[n] = 0;
        for (o in s)
    ...
    o.e = function(t) {
        ...
        if (0 !== n)
            if (n)
                ...
                s.src =  "/games/CleosHeartNG/app/cleosHeart.7/" + ({
                    0: "game",
                    2: "vendors~vendor"
                }[t] || t) + ".js";
                var c = Error()
    ...
    o.r = function(t) {
        $jscomp.initSymbol(),
        $jscomp.initSymbol(),
        "undefined" != typeof Symbol && Symbol.toStringTag && ($jscomp.initSymbol(),
    ...
    window.WEBPACK = !0,
    window.WEBPACK_VERSION = 1,
    window.GAMECODE = "273",
    window.MODE = "production",
    window.gameVersion = "(build 7 commit a691f95120b053d4b0332fc165e37e7f2f001438)",
    window.loadPackedVendorBundles = function() {
        return $jscomp.asyncExecutePromiseGeneratorProgram((function(t) {
            ...
            case 4:
                return t.yield(o.e(2).then(o.t.bind(null, 4, 7)), 5);
            case 5:
                return t.yield(o.e(2).then(o.t.bind(null, 5, 7)), 6);
            case 6:
                return t.yield(o.e(2).then(o.t.bind(null, 6, 7)), 0)
            }
        }
        ))
    }
    ...
    window.loadGameBundle = function() {
        return $jscomp.asyncExecutePromiseGeneratorProgram((function(t) {
            return t.yield(o.e(0).then(o.t.bind(null, 7, 7)), 0)
        }
        ))
    }
}
