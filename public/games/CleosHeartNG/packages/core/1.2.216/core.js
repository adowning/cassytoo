...
$jscomp.scope = {}, $jscomp.ASSUME_ES5 = !1, $jscomp.ASSUME_NO_NATIVE_MAP = !1, $jscomp.ASSUME_NO_NATIVE_SET = !1, $jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(e, t, n) {
    ...
    function(e) {
        ...
        n(1), n(2), n(9), n(177), n(202), n(216), window.nge._versions = window.nge._versions || {}, window.nge._versions.core = JSON.stringify("1.2.216") || "local"
    }, function(e, t) {
        ...
        nge.Com.Paytable.Controller = nge.Com.Base.extend((function() {
            ...
            this.preload = function() {
                ...
                var b = i % o;
                for (var m in l = (o * s - b * s) / 2, t) {
                    var d = t[m].awards,
                        y = nge.objects.create("paytableItemContainer", e);
                    y.visible = !0, y.id = m + "_itemContainer", y.name = m + "_itemContainer", y.x = r, y.y = c, u > i - b && (y.x += l), (g = y.create(0, 0, m)).id = m + "_logo", g.name = m + "_logo", g.width = p, g.height = h;
                    var _ = 0;
                    d.forEach((function(e) {
                        var t = nge.objects.create("paytableItemText", y);
                        t.x = f ? p + 50 : 100, t.y = f ? h / 5 * ((5 - d.length) / 2) : h + 15, t.visible = !0;
                    ...
                    })), r = 0 == u % o ? 0 : r + s, c += 0 == u % o ? h + a + (f ? 0 : 200) : 0, u++
                }
        ...
        nge.Com.SlotMachine.View = Class.extend((function() {
            ...
            this._cfg, this._pool, this._symbolSize, this._reelsSymbols, this._speedReelsCustom = [], Object.defineProperties(this, {
                ...
                C = e || "forward", v = b = !1, l._speedReelsCustom = [], l._setNewReelsCfg(!1), e = !1;
                ...
                for (var n in l._storeSymbols(), _ = !1, l._reelsSymbols = [], o = [], s = [], p = [], h = [], g) g[n].stop();
                ...
                for (var g = 0; g < n; g++) {
                    ...
                    var h = t.get();
                    x && (h = h.filter((function(e) {
                        return e.name === f
                    }))[0], p.z = (h.textureZ ? h.textureZ : 0) + .01 * g), c[g] = p
                }
                ...
                if (i) {
                    var h = nge.tween.add(e, "custom" === l._cfg.tweenType),
                        b = l.customReelStartCallback(e, t, h, a);
                    b && (h = b.tween, a = b.startDelay), g[t] = h
                }
                b = "forward" === C ? n.height + p : -n.height + p;
                return i && "linear" === s.animationType ? (s = (n.height + l._symbolSize.height * o) / (u - c), f[t] = s, h.to({
                    y: b
                ...
                if (nge.localData.set("slotMachineAdditionalBlurs", !1), r && (b || 0 >= m[t])) return l._reelSpinsFinish(t), !1;
                if (0 === t && 0 === m[0])
                    for (n = 0; n < l._cfg.mw; n++) m[n]++;
                if (m[t]--, !b && v && !l._speedReelsCustom[t] && g[t - 1] && !g[t - 1].isRunning)
                ...
                if (h[t] || (h[t] = []), n = nge.localData.get("slotMachineAdditionalBlursKeys"), i = "blurTemp", r && n && n[t] && n[t][m[t]] && (i = n[t][m[t]]), !(i = l._pool.release(i))) return !1;
                ...
                h[t].push(i), n = i.height, o = e.children[e.children.length - 1], i.y = "forward" === C ? o.y - n : o.y + o.height, e.addChild(i), 2 < h[t].length && (n = h[t].shift(), e.removeChild(n), l._pool.store(n.key ? n.key : "blurTemp", n)), p[t] && e.y >= p[t].height + i.height && l._storingMainBlur(e, t), l._storeOldSymbols(e, t), n = l._getReelOffsetY(t), i = l._getMH(t), l._newSymbolsAnimate(e, t, l._reelAnimationStepEnd, "forward" === C ? n : e.y - l._symbolSize.height * i + n)
            }, this._reelAnimationComplete = function(e, t) {
                if (nge.observer.fire("slotMachine.reel_" + t + ".animation.stop"), e) {
                    if (l._storeOldSymbols(e, t), l._reelsSymbols[t] = s[t], l._storingMainBlur(e, t), h[t]) {
                ...
                var a = 1;
                l._speedReelsCustom[t] ? a = l._speedReelsCustom[t] : b && (a = l._cfg.speedUpReelsFactor), "custom" === l._cfg.tweenType ? s = g[t] : (s = nge.tween.add(e), g[t] = s), "linear" === o.animationType ? s.to({
                    y: i
        ...
        nge.Com.Winlines.View = Class.extend((function() {
            ...
            this.create = function() {
                ...
                if (!1 !== g._cfg.rowsIndexesNormalizeValue && (b = g._cfg.rowsIndexesNormalizeValue), !1 !== b) return b;
                if (!t) return !1;
                for (var e = 0; e < t.length; e++)
                    for (var n = 0, i = t[e].length; n < i; n++) b = b > t[e][n] ? t[e][n] : b;
                return b
                ...
                if (l.width = 1920, l.height = 1080, c.translate(i.x, 0), g._cfg.buildWinLines)
                    for (var u = 0; u < t.length; u++) {
                        ...
                        var h = 0;
                        if (g._cfg.shadow) {
                            var b = g._cfg.stroke ? g._cfg.stroke.weight + g._cfg.lineWeight : g._cfg.lineWeight;
                            h = ++b + 4, g._drawLine(t[u], u, c, b, "0x000000", .2)
                        }
                        g._cfg.stroke && (g._drawLine(t[u], u, c, g._cfg.stroke.weight + g._cfg.lineWeight, g._cfg.stroke.colors[u], g._cfg.stroke.alpha), h = h || g._cfg.stroke.weight + g._cfg.lineWeight), g._drawLine(t[u], u, c, g._cfg.lineWeight, g._cfg.lineColors[u]), h = h || g._cfg.lineWeight, h = g._cutLine(t[u], u, c, h), (b = nge.objects.create(new nge.Mlm.Objects.Folder({
                            name: "winline_" + u
                        }))).visible = !1, b.add(h), n.push(b), g._cfg.cacheLineObjectsAsBitmap && (h.cacheAsBitmap = !0), r.add(b), g._cfg.numbers && (b = g._createLineNumber(u), o.add(b), f.push(b), u < p && g._highlightLineNumber(u)), nge.localData.get("winlines.updated") && u < p && this.show(u)
                    }
                ...
                var r, l = nge.objects.create(new nge.Mlm.Objects.Folder({})),
                    ...
                    h = g._cfg.globalOffset + g._cfg.lineOffsets[t];
                ...
                for (t = 0, r = e.length; t < r; t++) 0 === t ? p(d = c / 2 - f, y = e[0] * u + u / 2 + h, b = c / 2, m = y, !0) : p(d, y, b = t * c + c / 2, m = e[t] * u + u / 2 + h), d = b, y = m;
                return p(d, y, b + f, m), l
            }, this.show = function(e) {
                ...
                if (h = [], e && e.slotWin && e.slotWin.lineWinAmounts)
                    for (var t = 0; t < e.slotWin.lineWinAmounts.length; t++) h.push(e.slotWin.lineWinAmounts[t]);
                return e && e.slotWin && e.slotWin.jackpotWin && h.push(e.slotWin.jackpotWin), !0
            }, this.animateAll = function() {
                ...
                if (!h[r] || nge.localData.get("slotMachineSpinning")) return !1;
                nge.observer.fire("winlines.lineHighlite.start", h[r]), nge.rafClearTimeout(l);
                var e = nge.localData.get("autospin.inProgress"),
                    t = nge.localData.get("freespin.inProgress");
                if (g._cfg.fastAutoMode && (e || t)) return !1;
                this.hideAll(), void 0 !== h[r].selectedLine && g._cfg.showLinesOnWin && this.show(h[r].selectedLine), nge.observer.fire("winlines.lineHighlite.start.previousHided", h[r]), g._animateSymbols(h[r].wonSymbols), m = !1, l = nge.rafSetTimeout(g._animationOneByOneCallback, g._cfg.animationOneByOneDuration), u = "OneByOne", nge.observer.fire("winlines.lineHighlite.startComplete", h[r])
                ...
                l && nge.rafClearTimeout(l), e && (h = []), d = !0
                ...
                var e = 0;
                ++r >= h.length && (r = 0, e = 5, nge.observer.fire("winlines.animateByOne.cycleComplete")), 0 < e ? nge.rafSetTimeout((function() {
                    g.animateByOne()
                }), e) : g.animateByOne()
            }, this._animateAll = function() {
                if (!h || 0 === h.length || nge.localData.get("slotMachineSpinning")) return !1;
                if (l && nge.rafClearTimeout(l), d = !1, g._cfg.animateAllSymbols)
                    for (var e in h) g._animateSymbols(h[e].wonSymbols);
                ...
                for (var t = 0; t < h.length; t++)(e = h[t]) && void 0 !== e.selectedLine && (0 >= g._cfg.animationAllDelayPerLine ? nge.observer.fire("winlines.show", e.selectedLine) : function(e) {
                    nge.rafSetTimeout((function() {
                ...
                if (l = g._cfg.lineCustomCoords[t])
                    for (e = !0, t = 0; t < l.length; t++) {
                        ...
                        for (t = 0, l = e.length; t < l; t++) 0 === t ? p(d = c / 2 - f, y = e[0] * u + u / 2 + h, b = c / 2, m = y, !0) : p(d, y, b = t * c + c / 2, m = e[t] * u + u / 2 + h), d = b, y = m;
                        p(d, y, b + f, m)
                    }
                ...
                if ("left" === l || "both" === l) {
                    ...
                    if (g._cfg.numbersCustomDecoration) {
                        var h = new Phaser.Image(nge.game, f, p, new PIXI.Texture(PIXI.BaseTextureCache[g._cfg.numbersCustomDecoration]));
                        h.anchor.x = .5, h.anchor.y = .5, u.add(h)
                    }
                ...
                return "right" !== l && "both" !== l || (f = c * s + s / 2 + o + g._cfg.offsetFromLine, p = !1 === r ? t[e][c] * a + a / 2 + i : r, g._cfg.numbersCustomDecoration && ((h = new Phaser.Image(nge.game, f, p, new PIXI.Texture(PIXI.BaseTextureCache[g._cfg.numbersCustomDecoration]))).anchor.x = .5, h.anchor.y = .5, u.add(h)), nge.objects.create(new nge.Mlm.Objects.Text({
                    x: f,
                    y: p,
                    text: e + 1,
                    style: n,
        ...
        function a() {
            h && f && (h = !1, f.length ? p = f.concat(p) : b = -1, p.length && r())
        }
        ...
        e.nextTick = function(e) {
            ...
            p.push(new l(e, t)), 1 !== p.length || h || o(r)
                ...
                var l = -1 === e.indexOf("."),
                    ...
                    u = function(i, g) {
                        ...
                        for (f = 0; f < i.length; f++) {
                            var p = i[f],
                                h = l ? p[e] : nge.Lib.Helper.recursiveGet(e, p);
                            if (h === t || o && void 0 !== h && h && -1 !== h.indexOf(t)) {
                                if (a && delete i[f], s) return p;
                                r.push(p)
                            }
                            if (p[n] && 0 < p[n].length && (h = u(p[n], g)) && (a && (p[n] = c(p[n])), s)) return h
                        }
                        return !1
                    };
                return u([i], t) || !s && r
            ...
            Object.defineProperties(this, {
                ...
                var s = f(),
                    p = {
                        ...
                        onComplete: {
                            addOnce: function(e) {
                                return p._functions.onComplete.push(e), this
                            },
                            add: function(e) {
                                return p._functions.onComplete.push(e), this
                            }
                        ...
                        onStart: {
                            addOnce: function(e) {
                                return p._functions.onStart.push(e), this
                            }
                        },
                        onUpdateCallback: function(e) {
                            return p._functions.onUpdate.push(e), this
                        }
                    };
                return e[s] = p
            };
            var a = function(e, t, i, o, s) {
                ...
                r = function() {
                    ...
                    if (0 === this.points.length && 0 < this._bkp.points.length) {
                        this.points = this._bkp.points, this.points[0].timeStart = n + this.points[0].startDelay;
                        var t = f();
                        e[t] = this
                    }
                    for (this._bkp = {
                            ...
                            obj: null
                        }, this.isRunning = this._started = !0, this._complete = !1, t = 0; t < this._functions.onStart.length; t++) this._functions.onStart[t]();
                ...
                p = function(e, t) {
                    ...
                    if (1 === t)
                        if (e.points.shift(), 0 === e.points.length) {
                            ...
                            for (e.enableUpdate || (e._functions.onStart = [], e._functions.onUpdate = [], e._functions.onComplete = []), i = 0; i < s.length; i++) s[i]()
                        } else {
                            for (s in t = e.points[0].startDelay, e.points[0].timeStart = n + t, e.points[0].propsTo) e.points[0].propsFrom[s] = e.target[s];
