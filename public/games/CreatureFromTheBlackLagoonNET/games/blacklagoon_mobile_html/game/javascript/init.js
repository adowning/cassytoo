...
(window.Sys = {}),
        ...
        (Sys.openBetMode = !1),
            ...
            (function () {
                var e,
                    ...
                    t = !1;
                void 0 !== s.style.webkitPerspective &&
                    ...
                    (Sys.has3DTransforms = t);
            })(),
            s.match(/Chrome/i) &&
                ((Sys.isChrome = !0),
                s.match(/Chrome\/28[\.\d]/i) && (Sys.isChrome280 = !0)),
            s.match(/CriOS/i) && (Sys.isChromeForIOS = !0),
            s.match(/Safari/i) && !Sys.isChromeForIOS && (Sys.isSafari = !0),
            null !== s.match(/iPad/i)
                ? (Sys.isiPad = !0)
                : s.match(/iPod/i)
                ? (Sys.isiPod = !0)
                ...
                : s.match(/Android/i) || s.match(/HTC_Sensation/i)
                ? ((Sys.isAndroidDevice = !0),
                  s.match(/Android 3[\.\d]+/i)
                      ? ((Sys.isAndroid3Tablet = !0),
                        (Sys.isAndroidTablet = !0))
                      : s.match(/mobile/i)
                      ? s.match(/Android 2\.3/i)
                          ? (Sys.isAndroid23Device = !0)
                          : s.match(/Android 4\.0/i)
                          ? (Sys.isAndroid400 = !0)
                          : s.match(/Android 4\.1/i)
                          ? (Sys.isAndroid410 = !0)
                          : s.match(/Android 4\.2/i)
                          ? (Sys.isAndroid420 = !0)
                          : s.match(/Android 4\.3/i) && (Sys.isAndroid430 = !0)
                      : (Sys.isAndroidTablet = !0))
                : (Sys.isDesktop = !0),
            (Sys.isiPhoneIOS7 =
                s.indexOf("IEMobile") < 0 &&
                /(?:OS\s*[7]+_0(?:_\d+)?\s*)/i.test(s) &&
    ...
    (Sys.applyProperties = function (e, i) {
        var s,
            ...
            o = n.length;
        for (s = -1; ++s < o; )
            (t = n[s]), Sys.isDefined(i[t]) && (e[t] = i[t]);
        return e;
    }),
    ...
    (Sys.applyPropertiesIf = function (e, i) {
        ...
        for (s = -1; ++s < o; )
            (t = n[s]),
                !Sys.isDefined(e[t]) && Sys.isDefined(i[t]) && (e[t] = i[t]);
        return e;
    }),
    ...
    (Sys.ns = function (e) {
        var i,
            s,
            t = e || "";
        for (i = t.split(".") || [], s = window; i.length > 0; )
            (t = i.shift()), Sys.isEmpty(s[t]) && (s[t] = {}), (s = s[t]);
    }),
    ...
    (Sys.overrideClass = function (e, i) {
        ...
        return (
            Sys.isObj(i) &&
                (Sys.apply(e.prototype, i),
                (s = e.prototype),
                (t = e.superclass),
                "function" == typeof i.constructor && (e = i.constructor),
                (e.prototype = s),
                (e.superclass = t)),
            e
        );
    ...
    (Sys.extend = function (e, i, s) {
        ...
        return (
            ...
            e.prototype.constructor === t && (e.prototype.constructor = e),
            (i.superclass = e.prototype),
            Sys.override(i, n),
            i
        );
    }),
    ...
    (Sys.range = function (e, i, s) {
        var t,
            ...
            r = e > i;
        for (
            t = r ? -1 * Math.abs(s) || -1 : Math.abs(s) || 1, n = e + t;
            r ? n >= i : n <= i;
    ...
    (Sys.reduce = function (e, i, s) {
        ...
        for (
            Sys.isDefined(s) || ((s = e[0]), (e = e.slice(1))),
                t = 0,
                n = e.length;
            t < n;
            t++
    ...
    (Sys.find = function (e, i) {
        ...
        for (s = 0, t = e.length; s < t; s++) if (i(e[s])) return e[s];
    });
(Sys.EventHandler = function () {
    ...
    (Sys.EventHandler.prototype = {
        ...
        addListener: function (n, e) {
            var t = this;
            Sys.isDefined(t.EVENTS[e]) || (t.EVENTS[e] = []),
                Sys.contains(t.EVENTS[e], n) || t.EVENTS[e].push(n);
        },
        ...
        dispatchEvent: Sys.variadic(function (n, e) {
            ...
            for (t = E; t >= 0; t--)
                (s = r[t]),
                    (i = Sys.isObj(s) ? s.handlers[n] : null) && i.apply(s, e);
            for (t = E; t >= 0; t--)
                "removed" === r[t] && (r.splice(t, 1), ++t);
        }),
        sortEventListeners: function (n) {
            ...
            for (s = -1; ++s < E; )
                (e = i[r[s]]),
                    (t = e.indexOf(n)) > 0 && (e.splice(t, 1), e.unshift(n));
        },
    }),
...
Sys.ns("Sys"),
    ...
    (Sys.Observable.prototype = {
        ...
        on: function (e) {
            for (
                var n, t = this, s = Object.keys(e), i = s.length, r = 0;
                r < i;

            )
                (n = s[r]), t.addListener(n, e[n]), ++r;
        },
        off: function () {
            for (
                var e,
                    n = this,
                    t = Object.keys(n.handlers),
                    s = t.length,
                    i = 0;
                i < s;

            )
                (e = t[i]), n.removeListener(e), ++i;
        },
    ...
    (Sys.Element = {
                    ...
                    ? ("string" == typeof e
                          ...
                          : Sys.isObj(e) &&
                            ...
                            Object.keys(e).forEach(function (t) {
                                var s = e[t];
                                "cls" === t
                                    ? this.el.setAttribute("class", s)
                                    : "innerHTML" === t
                                    ? (this.el.innerHTML = s)
                                    : "textContent" === t
                                    ? (this.el.textContent = s)
                                    : "onClick" === t
                                    ? this.el.addEventListener("click", s)
                                    : "items" === t
                                    ...
                                    : "transitionend" === t &&
                                      "function" == typeof s
                                    ? (this.transitionEnd = s)
                                    : "renderTo" !== t &&
                                      "tag" !== t &&
                                      this.el.setAttribute(t, s);
                            }, this)),
                      this.el)
                    : null
            );
        ...
        removeListener: function (e, t, s) {
            ...
            Sys.Element.superclass.removeListener.apply(this, arguments),
                this.DOMEvents[e].forEach(function (s, l) {
                    return (
                        s.event === e &&
                        s.func === t &&
                        s.scope === n &&
                        (this.DOMEvents[e].splice(l, 1),
                        this.el.removeEventListener(e, s.wrappedFn, !1),
                        !0)
                    );
                }, this);
        },
    ...
    (Sys.Deferred.prototype = {
        ...
        onDeferredUpdated: function () {
            ...
            Sys.each(
                ...
                this.isWaiting() ||
                    ((t = []),
                    Sys.each(this.whenList, function (s) {
                        t = t.concat(s.args);
                    }),
        ...
        onStateUpdated: function () {
            ...
            for (
                ...
                if (
                    ((t = i[s].fn.apply(i[s].scope, this.args)),
                    Sys.isObj(t) && s + 1 < e)
                ) {
    ...
    (function () {
        var e = {
            ...
            getResponseParameter: function (e, t) {
                var n = new RegExp(e + "=([^&]+)"),
                    r = Sys.isDefined(t.responseText)
            ...
            getNodesByFormat: function (e, t) {
                var n,
                    ...
                    o = 0;
                return (
                    e.replace(/\{([^\{\}]*)\}/g, function (e, i, a, u) {
                        s.push(document.createTextNode(u.slice(o, a))),
                            (o = a + e.length),
                            (n = function () {
                                ...
                                return "string" == typeof e || Sys.isNumber(e)
                                    ? (s.push(
                                      ...
                                      e)
                                    : (Sys.isObj(e) && s.push(e.getEl()), "");
                            }),
                            n.apply(r, arguments);
                    }),
                    o < e.length &&
                        s.push(document.createTextNode(e.slice(o, e.length))),
                    s
                );
            },
            ...
            addCSSClass: function (e, t) {
                Sys.utils.hasCSSClass(e, t) ||
                    (e.className = Sys.utils.trimClassName(
                        e.className + " " + t
                    ));
            },
            ...
            replaceCSSClass: function (e, t, n, r) {
                ...
                Sys.utils.hasCSSClass(e, t)
                    ? ((s = new RegExp("(^|\\s)(" + t + ")($|\\s)")),
                      (o = o.replace(s, "$1" + n + "$3")),
                      (e.className = Sys.utils.trimClassName(o)))
                    : r && Sys.utils.addCSSClass(e, n);
            },
            ...
            tryPrefixPropery: function (e, t) {
                ...
                if (Sys.isDefined(e)) {
                    if (e in t) return e;
                    for (
                        r = e.charAt(0).toUpperCase() + e.substr(1), s = 0;
                        s < o.length;
                        s++
                    )
            ...
            parseQueryString: function (e, t) {
                ...
                for (n = 0; n < c.length; n++) {
                    for (
                        r = c[n].split("="), s = r[0].split("."), i = l, o = 0;
                        o < s.length - 1;
                        o++
                    )
                        i[s[o]] || (i[s[o]] = {}), (i = i[s[o]]);
                    (a = s[s.length - 1]),
                        (u =
                            !0 === t
                                ? this.parseValue(decodeURIComponent(r[1]))
            ...
            parseReelInfo: function (e, t) {
                ...
                for (
                    ...
                    (s = {
                        ...
                        n["i" + r].overlay &&
                            (s.overlaySymbols = this.getOverlaySymbols(
                                n["i" + r].overlay
                            )),
                        o.push(s);
                return o;
            ...
            processLobbyUrl: function (e, t) {
                var n,
                    r = Resources.readData("queryData"),
                    s = Resources.readData("sessionID"),
                    o = /#.*/,
                    i = "";
                return (
                    o.test(e)
                        ? ((i = o.exec(e)[0]), (n = e.replace(o, "")))
                        : (n = e),
                    void 0 !== t &&
...
!(function (t) {
    ...
    !t.AudioContext &&
        ...
        e.prototype.createGain ||
            ((AudioContext.prototype._createGain = e.prototype.createGainNode),
            (AudioContext.prototype.createGain = function () {
                var t = this._createGain();
                return o(t.gain), t;
            })),
        e.prototype.createDelay ||
            ((AudioContext.prototype._createDelay =
                e.prototype.createDelayNode),
            (AudioContext.prototype.createDelay = function () {
                var t = this._createDelay();
                return o(t.delayTime), t;
            })),
        (AudioContext.prototype.createScriptProcessor =
            e.prototype.createScriptProcessor ||
            e.prototype.createJavascriptNode),
        (AudioContext.prototype._createOscillator =
            e.prototype.createOscillator),
        ...
        (AudioContext.prototype._createBufferSource =
            e.prototype.createBufferSource),
        (AudioContext.prototype.createBufferSource = function () {
            var t = this._createBufferSource();
            return (
                t.start || (t.start = t.noteGrainOn || t.noteOn),
                t.stop || (t.stop = t.noteOff),
                o(t.playbackRate),
                t
            );
...
Sys.ns("Platform"),
    (Platform.PlatformManager = {
        ...
        gatherUserAgentInformation: function () {
            ...
            /Windows Phone/i.test(i)
                ...
                /Android/i.test(i) &&
                    ...
                    /PRA-LX1|PRA-LA1|PRA-TL10|PRA-TL20|PRA-LX2|TAG-L21|PRA-AL00X|TAG-L32|PRA-LX3|PRA-AL00|ALE-L21|ALE-L02|hi6210sft|ALE-L23|ALE-CL00|ALE-TL00|ALE-L04|ALE-UL00/i.test(
                        i
                    ) && (Platform.isHuaweiP8LiteDevice = !0),
                    /EVA-L09|EVA-L19|EVA-L29|EVA-AL10|EVA-TL00|EVA-AL00|A168-L09|B180|EVA-DL00/i.test(
                        i
                    ) && (Platform.isHuaweiP9Device = !0),
                    /VNS-L21|VNS-L22|VNS-L23|VNS-L31|VNS-L53|VNS-AL00|hi6250|PRA-LX3|VNS-L62/i.test(
                        i
                    ) && (Platform.isHuaweiP9LiteDevice = !0)),
                ...
                (Platform.isMQQBrowser = /MQQBrowser/i.test(i)),
        ...
        isLowMemoryWinPhone: function (e) {
            ...
            return !!(
                /Lumia/i.test(e) &&
                ((i = e.match(/[L|l]umia (\d+)/i)), t.indexOf(i[1]) > -1)
            );
        },
        ...
        consolidatePlatformKnowledge: function () {
            ...
            (t = t || Platform.isIphone3GSDevice),
                (t = t || (e && i && 28 === Platform.isChromeMajorVersion)),
                (Platform.isWebAudioEnabled =
                    Platform.hasWebAudioContext && !t);
        },
        ...
        determineResourceBundle: function () {
            ...
            if (!Sys.isDefined(Platform.resourceBundle)) {
                for (
                    t.detectPlatformFeatures(),
                        t.consolidatePlatformKnowledge(),
                        t.applyOverrides(),
                        e = 0;
                    e < t.AVAILABLE_RESOURCE_BUNDLES.length;
                    e++
                )
                    if (
                        ((i = Platform["_" + t.AVAILABLE_RESOURCE_BUNDLES[e]]),
        ...
        determineAudioConfiguration: function (e) {
            var i,
                t,
                o = Platform.hasWebAudioContext ? "webAudio" : "legacyAudio",
                r = "";
            return (
                "webAudio" !== o ||
                    Platform.isDesktopDevice ||
...
Sys.ns("Utils"),
    (Utils.Platform = {
        ...
        init: function () {
            ...
            window.addEventListener(
                ...
                function () {
                    ...
                    e.DEBUG && console.info("Orientation changed to:", t),
                ...
                window.addEventListener(
                    "resize",
                    function () {
                        e.DEBUG && console.info("Resize triggered."),
                            EventHandler.dispatchEvent(
        ...
        getOrientation: function () {
            return Platform.isDesktopDevice || Platform.isTabletDevice
                ? this.LANDSCAPE
                : !this.inIframe() && window.screen && window.screen.orientation
                ? window.screen.orientation.type.indexOf("portrait") > -1
                    ? this.PORTRAIT
                    : this.LANDSCAPE
        ...
        is3DTransformSupported: function () {
            ...
            return (
                ...
                e.forEach(function (e) {
                    t.style[e] &&
                        ((t.style[e] = "translate3d(1px,1px,1px)"),
                        (n = window.getComputedStyle(t).getPropertyValue(e)));
                }),
...
Sys.ns("Sys"),
    (Sys.Environment = {
        ...
        getViewportOrientation: function (t) {
            return this.allowsCustomCanvasSize() && !t
        ...
        getWindowToVirtualScale: function (t) {
            return parseFloat(
                (1 / this.determineResolution().virtualToWindowScale).toFixed(t)
            );
        },
        ...
        identifyBrowser: function () {
            var t = navigator.userAgent,
                e = this.os,
                i = "";
            t.match(/CriOS/i) || t.match(/Chrome/i)
                ? (i = "chrome")
                : t.match(/MSIE [0-9]*\.[0-9]*;/i)
                ? (i = "ie")
                : t.match(/Safari/i)
                ? "ios" === e
                    ? (i = "safari")
                    : "android" === e && (i = "stock")
                : t.match(/Firefox/i) && (i = "firefox"),
                (this.browser = i);
        },
        identifyPlatform: function () {
            ...
            Platform.isTabletDevice
                ? (t = "tablet")
                : Platform.isDesktopDevice && (t = "desktop"),
                (this.platformCSS = t),
                "desktop" !== t && Platform.isLowEndDevice && (t += "Low"),
                (this.platform = t);
        },
        getOrientation: function () {
            ...
            var i = {
                ...
                o = function (t, e) {
                    return Math.abs(t.diff) < Math.abs(e.diff)
                        ? -1
                        : Math.abs(t.diff) > Math.abs(e.diff)
                        ? 1
                        : 0;
                };
            return (
                Sys.iterate(e, function (t, e) {
                    var o,
                        ...
                        a,
                        u = e;
                    (o = Math.abs(u.width - i.width)),
                        (r = Math.abs(u.height - i.height)),
                        (s = o + r),
                        (a = Math.abs(u.ratio - i.ratio)),
                        (u.diff = s * (1 + a)),
                        n.push(u);
                }),
                n.sort(o),
        ...
        getOrientationSpecificConfig: function (t, e) {
            var i = Utils.Platform.getOrientation(),
                ...
                o = "base",
                r = {};
            return Sys.isDefined(t) && null !== t
                ? (e
                      ? ((n = n.toUpperCase()), (o = o.toUpperCase()))
                      : ((i = i.toLowerCase()), (o = o.toLowerCase())),
                  Sys.isDefined(t[o])
                      ? ((r = Sys.applyProperties(r, t[o])),
                        (r = Sys.applyProperties(r, t[i] || {})))
                      : t[i] || t[n] || null)
                : null;
        },
        ...
        getCroppedViewportBottomOffset: function () {
            ...
            return Math.abs(
                t.height - Utils.Platform.getViewportInnerSize().height
            );
        },
        ...
        goToLobby: function (t) {
            ...
            Sys.isDefined(i) &&
                Sys.isDefined(t) &&
                (i = Sys.utils.appendParameterToQuery(i, "reason=" + t)),
                Sys.isDefined(n) &&
                    (Sys.isDefined(i) &&
                        Sys.isDefined(n.gameId) &&
                        (i = Sys.utils.appendParameterToQuery(
                            i,
                            "gameId=" + n.gameId
                        )),
                    Sys.isDefined(i) &&
        ...
        isStartEvent: function (t) {
            ...
            return (
                "mousedown" !== t.type || e.leftButtonClicked(t) || (i = !1), i
            );
        },
        isEndEvent: function (t) {
            ...
            return (
                "mouseup" !== t.type || e.leftButtonClicked(t) || (i = !1), i
            );
        },
            ...
            window.navigator.pointerEnabled || window.navigator.msPointerEnabled
                ? (e.push(
                  ...
                  Utils.Platform.isTouchSupported() ||
                      r.push(t.getMouseWheelEventName()),
                  u.push("pointerEvent"))
                : (Utils.Platform.isTouchSupported() &&
                      (e.push("touchstart"),
                      i.push("touchmove"),
...
Sys.ns("Sys"),
    (Sys.Resources = {
        ...
        storeData: function (t, e) {
            return (
                (this.data[t] = e),
                this.fireEvent("notify:resources.dataStored", t),
                this.data[t]
            );
        },
...
(Array.prototype.sum = function () {
    ...
    (Array.prototype.indexOf = function (t) {
        var r,
            n = this.length;
        for (r = -1; ++r < n; ) if (this[r] === t) return r;
        return -1;
    }),
    ...
    getDOMElementFromCoordinates: function (e) {
        ...
        return !Sys.isObj(e) || (Sys.isDefined(e.x) && Sys.isDefined(e.y))
            ? ((t = document.elementFromPoint(e.x, e.y)),
              Sys.isEmpty(t) || 3 !== t.nodeType || (t.target = t.parentNode),
              t)
            : null;
    },
    ...
    (Core.LanguageManager = {
        ...
        preload: function (e) {
            ...
            ("languageJSON" !== e && "languageXML" !== e) ||
                ((n = Resources.readData(e)),
                "languageJSON" === e
                    ? (this.texts = this.loadLanguage(n))
                    : "languageXML" === e &&
                      (this.texts = this.loadLanguageXML(n)),
        ...
        getText: function (e, n) {
            ...
            return this.hasText(e)
                ? "" === this.texts[e]
                    ? "[" + e + " not translated]"
                    : ((o = this.texts[e].replace("%2B", "+")),
                      n
                          ? ((t = Sys.utils.getNodesByFormat(o, n)),
...
(Sys.UserInput = {
        ...
        return (
            Utils.Platform.isTouchSupported() && Platform.isDesktopDevice
                ? (t.push("mousedown"),
                  ...
                  n.push("touchend"),
                  i.push("touchcancel"),
                  s.push(this.getMouseWheelEventName()))
                : Utils.Platform.isTouchSupported()
                ? (t.push("touchstart"),
                  e.push("touchmove"),
                  n.push("touchend"),
                ...
                : (t.push("mousedown"),
                  ...
                  i.push("mouseout"),
                  s.push(this.getMouseWheelEventName())),
            Platform.isDesktopDevice && (a.push("keyup"), o.push("keydown")),
            {
                start: t,
                move: e,
                end: n,
    ...
    addEventListeners: function () {
        ...
        e.start.forEach(function (e) {
            ...
            e.keyUp.forEach(function (e) {
                document.addEventListener(
                    e,
                    t.interactionEventHandlers.keyUp,
                    !1
                );
            }),
            e.keyDown.forEach(function (e) {
                document.addEventListener(
                    e,
                    t.interactionEventHandlers.keyDown,
                    !1
                );
            }),
            document.body.addEventListener(
    ...
    deactivateExclusivity: function (t) {
        ...
        "string" == typeof t && i.requester === t
            ...
            e
                ? s.length > 0
                    ? this.setExclusiveEvents(s.shift())
                    : this.storeData("exclusivityRequested", !1)
                : (n = s.indexOf(t)) >= 0 && s.splice(n, 1);
    },
    ...
    handleInteractionKeyDown: function (t) {
        ...
        this.isState("deactivated") ||
            e ||
            !this.isKeyDownEvent(t) ||
            (this.storeData("activeInteraction", t.keyCode),
            this.sendInputEvent("keyDown", t));
    },
...
Sys.ns("Core"),
    (Core.Scaling = {
        ...
        calculateScale: function () {
            ...
            return (
                (e =
                    Platform.isSafariBrowser && Platform.isIOS13Device
                        ? Utils.Platform.getViewportInnerSize()
                        : Utils.Platform.getViewportSize()),
                (t = e.height / o.height),
                (i = e.width / o.width),
            ...
            start: function (e, a, i, o, u, f) {
                ...
                var F = function (r) {
                    ...
                    if (!t[v] || (a && !a(v)))
                        return (
                            (t[v] = null),
                            void (i && i(60 - s / ((q - c) / 1e3), v, !1))
                        );
                    if (A)
                        for (
                            var w = Math.round((q - m) / (1e3 / 60)) - 1, d = 0;
                            d < Math.min(w, 4);
                            d++
                        )
                            F(!0), s++;
                    ...
                    (!1 !== e(h, q, A) && 1 !== l) || !A
                        ? A &&
                          ((m = q),
                          core.effect.Animate.requestAnimationFrame(F, f))
                        : ((t[v] = null),
                          i &&
                              i(
                                  60 - s / ((q - c) / 1e3),
        ...
        t = {
            ...
            scrollTo: function (e, o, _, t) {
                ...
                l.options.scrollingX
                    ? l.options.paging
                        ? (e =
                              Math.round(e / l.__clientWidth) * l.__clientWidth)
                        : l.options.snapping &&
                          (e = Math.round(e / l.__snapWidth) * l.__snapWidth)
                    : (e = l.__scrollLeft),
            ...
            doTouchMove: function (e, o, _) {
                ...
                if (t.__isTracking) {
                    ...
                    if (t.__isDragging) {
                        ...
                        (t.__enableScrollX = t.options.scrollingX && T >= v),
                            (t.__enableScrollY =
                ...
                if (o.__isTracking) {
                    ...
                    o.__isDecelerating ||
                        (o.__refreshActive && o.__refreshStart
                            ...
                            : ((o.__interruptedAnimation || o.__isDragging) &&
                                  o.options.scrollingComplete(),
                              o.scrollTo(
                                  o.__scrollLeft,
                                  o.__scrollTop,
            ...
            __publish: function (e, t, l, i) {
                var n = this,
                    r = n.__isAnimating;
                if (
                    (r && (core.effect.Animate.stop(r), (n.__isAnimating = !1)),
    ...
    (dat.utils.common = (function () {
        ...
        return {
            ...
            compose: function () {
                ...
                return function () {
                    for (
                        var n = t.call(arguments), o = e.length - 1;
                        o >= 0;
                        o--
                    )
                        n = [e[o].apply(this, n)];
                    ...
                    ? 0 == this.initialValue
                        ...
                        : (this.__impliedStep =
                              Math.pow(
                                  10,
                                  Math.floor(
                                      Math.log(this.initialValue) / Math.LN10
                                  )
                              ) / 10)
...
cssConverterElement.appendChild(document.createTextNode(rawCssText)),
    (dat.controllers.NumberControllerSlider = (function (e, t, n, o, i) {
        ...
        var s = function (e, n, o, i, a) {
            ...
            function d(e) {
                ...
                return (
                    u.setValue(
                        r(e.clientX, n.left, n.left + o, u.__min, u.__max)
                    ),
                    !1
                );
            }
    ...
    cssConverterElement.appendChild(document.createTextNode(rawCssText)),
    (dat.GUI = dat.gui.GUI =
        (function (e, t, n, o, i, r, s, a, l, d, c, u, h, p, _) {
            function f(e, t, n, r) {
                if (void 0 === t[n])
                    throw new Error(
                ...
                return (
                    p.addClass(u, F.CLASS_CONTROLLER_ROW),
            ...
            function g(e, t, n) {
                if (
                    ...
                    var i = function (t) {
                        return _.isNumber(n.__min) && _.isNumber(n.__max)
                            ? (n.remove(),
                              f(e, n.object, n.property, {
                                  before: n.__li.nextElementSibling,
            ...
            function y(e) {
                ...
                if (
                    (e.load && e.load.remembered
                        ? _.each(e.load.remembered, function (t, n) {
                              E(e, n, n == e.preset);
                          })
                        : E(e, L, !1),
                    ...
                    "true" === localStorage.getItem(v(e, "isLocal")) &&
            ...
            function x(e) {
                function t(t) {
                    return (
                        t.preventDefault(),
                        (i = t.clientX),
                        p.addClass(e.__closeButton, F.CLASS_DRAG),
                ...
                function o() {
                    p.removeClass(e.__closeButton, F.CLASS_DRAG),
            ...
            function C(e, t) {
                var n = {};
                return (
                    _.each(e.__rememberedObjects, function (o, i) {
                        var r = {},
            ...
            var T,
                ...
                F = function (e) {
                    ...
                    (this.domElement = document.createElement("div")),
                        ...
                        _.isUndefined(e.load)
                            ? (e.load = {
                                  preset: L,
                              })
                            : e.preset && (e.load.preset = e.preset),
                        _.isUndefined(e.parent) && e.hideable && D.push(this),
                        (e.resizable = _.isUndefined(e.parent) && e.resizable),
                        e.autoPlace &&
                            _.isUndefined(e.scrollable) &&
                            (e.scrollable = !0);
                    var n,
                        o =
                            N &&
                            "true" === localStorage.getItem(v(this, "isLocal"));
                    if (
                        (Object.defineProperties(this, {
                            ...
                            closed: {
                                ...
                                set: function (n) {
                                    (e.closed = n),
                                        e.closed
                                            ? p.addClass(t.__ul, F.CLASS_CLOSED)
                                            : p.removeClass(
                                                  t.__ul,
                                                  F.CLASS_CLOSED
                                              ),
                            ...
                            useLocalStorage: {
                                ...
                                set: function (e) {
                                    N &&
                                        ((o = e),
                                        e
                                            ? p.bind(window, "unload", n)
                                            : p.unbind(window, "unload", n),
                    ...
                    e.autoPlace &&
                        (_.isUndefined(e.parent) &&
                            (R &&
                                ...
                                p.addClass(O, "dg"),
                                p.addClass(O, F.CLASS_AUTO_PLACE_CONTAINER),
                                document.body.appendChild(O),
                                (R = !1)),
                            O.appendChild(this.domElement),
                            p.addClass(this.domElement, F.CLASS_AUTO_PLACE)),
                        this.parent || w(t, e.width)),
                        ...
                        (n = function () {
                            N &&
                                "true" ===
                                    localStorage.getItem(v(t, "isLocal")) &&
                                localStorage.setItem(
                                    v(t, "gui"),
                                    JSON.stringify(t.getSaveObject())
                                );
                        }),
                ...
                _.extend(F.prototype, {
                    ...
                    saveAs: function (e) {
                        this.load.remembered ||
                            ((this.load.remembered = {}),
                            (this.load.remembered[L] = C(this, !0))),
            ...
            (dat.controllers.factory = (function (e, t, n, o, i, r, s) {
                return function (a, l) {
                    ...
                    return s.isArray(arguments[2]) || s.isObject(arguments[2])
                        ? new e(a, l, arguments[2])
                        : s.isNumber(d)
                        ? s.isNumber(arguments[2]) && s.isNumber(arguments[3])
                            ? new n(a, l, arguments[2], arguments[3])
                            : new t(a, l, {
                                  min: arguments[2],
                                  max: arguments[3],
                              })
            ...
            (dat.controllers.ColorController = (function (e, t, n, o, i) {
                ...
                var a = function (e, l) {
                    ...
                    function p(e) {
                        ...
                        var n = t.getWidth(f.__saturation_field),
                            ...
                            r =
                                1 -
                                (e.clientY - o.top + document.body.scrollTop) /
                                    n;
                        return (
                            r > 1 ? (r = 1) : r < 0 && (r = 0),
                            i > 1 ? (i = 1) : i < 0 && (i = 0),
                    ...
                    i.extend(this.__selector.style, {
                        ...
                        i.extend(this.__input.style, {
                            ...
                            fontWeight: "bold",
                            textShadow:
                                this.__input_textShadow + "rgba(0,0,0,0.7)",
                        }),
                ...
                dat.controllers.Controller,
                dat.dom.dom,
                (dat.color.Color = (function (e, t, n, o) {
                    function i(e, t, n) {
                        Object.defineProperty(e, t, {
                            get: function () {
                                return "RGB" === this.__state.space
                                    ? this.__state[t]
                                    : (s(this, t, n), this.__state[t]);
                            },
                            set: function (e) {
...
!(function (t, n, e) {
    ...
    function o(n) {
        ...
        var o = n.height,
            r = n.width;
        return (
            (o = "function" == typeof o ? o.call(n) : o),
            (r = "function" == typeof r ? r.call(n) : r) / o
        );
    }
    var r = {},
    ...
    (Core.DeviceDetectionService = (function () {
        ...
        return (
            ...
            (r = function (r, o, n) {
                ...
                for (R = 0; R < l; R++)
                    if (
                        ...
                        (i = n[C[R]]),
                        (c = !1),
                        (s = new RegExp(i.matchPattern)),
                        i.excludePattern &&
                            (c = new RegExp(i.excludePattern).test(r)),
                        s.test(r) && !c)
                    )
                        return (
                            t.version
            ...
            (o = function (e, o) {
                var n,
                    t,
                    i = o.definitions.operatingSystems,
                    s = o.ruleSets.white || {},
                    c = r(e, s, i),
                    a = {};
                if (c) {
                    if (
                        ((a.allowed = !0),
                        (a.preferredBrowser = i[c.name].preferredBrowser),
                        !c.inRange)
                    )
                        return (
                            (a.code =
                    ...
                    (t = s[c.name].browsers),
                        (n = r(e, t || {}, o.definitions.browsers)),
                        t
                            ? n
                                ? n.inRange
                                    ? (a.code = Core.DeviceDetectionCodes.WHITE)
                                    : (a.code =
            ...
            (n = function (e, o) {
                var n,
                    ...
                    i,
                    s,
                    c = o.definitions.operatingSystems,
                    a = o.ruleSets.black || {},
                    d = r(e, a, c),
                    R = {};
                return (
                    d &&
                        ...
                        ((n = a[d.name]),
                        (t = n.browsers),
                        (i = r(e, t || {}, o.definitions.browsers)),
                        i && i.inRange
                            ? ((s = t[i.name]),
                              (R.preferredBrowser = c[d.name].preferredBrowser),
                              (R.allowed = !1),
                              s.version
                                  ? (R.code =
                            ...
                            : ((R.allowed = !1),
                              (R.code = Core.DeviceDetectionCodes.BLACK_OS))),
                    R
                );
            }),
            (t = function (e, r) {
                ...
                return t
                    ...
                    : (Sys.applyProperties(i, o(e, r)),
                      Sys.applyProperties(i, n(e, r)),
                      i);
            }),
            {
        ...
        return {
            ...
            compareVersions: function (e, r) {
                ...
                if (
                    ...
                    !Core._DeviceDetectionUtils.isVersionNumber(r)
                )
                    throw new Error(
                        "The versions provided are not valid versions"
                    );
                for (
                    o = e.split(".").map(parseFloat),
                        s = r.split(".").map(parseFloat);
                    o.length < s.length;
            ...
            isInRange: function (e, r, i) {
                ...
                return (
                    r &&
                        Core._DeviceDetectionUtils.compareVersions(e, r) < 0 &&
                        (t = !1),
                    i &&
                        Core._DeviceDetectionUtils.compareVersions(e, i) > 0 &&
                        (n = !1),
                    t && n
                );
            },
    ...
    (Sys.utils.XMLHelper = {
        getNodeValue: function (t, e) {
            ...
            return e.getElementsByTagName &&
                ((n = e.getElementsByTagName(t)), n.length > 0)
                ? n[0].textContent
                : null;
        },
        ...
        findAll: function (t, e) {
            return !Sys.isEmpty(e) && e.getElementsByTagName
                ? e.getElementsByTagName(t)
                : [];
        },
        getAttributeValue: function (t, e) {
            return e.attributes && e.hasAttribute(t)
                ? e.attributes.getNamedItem(t).value
                : null;
        },
        toJSON: function (t) {
            var e,
            ...
            if (t.hasChildNodes())
                for (
                    u.children = [], i = 0, r = t.childNodes.length;
                    i < r;
                    i++
                )
                    (e = t.childNodes.item(i)),
                        1 === e.nodeType
                            ? u.children.push(this.toJSON(e))
                            : 3 === e.nodeType &&
                              (u.text = e.nodeValue.replace(/^\s+|\s+$/g, ""));
            if (t.attributes)
                for (
                    u.attributes = {}, i = 0, r = t.attributes.length;
                    i < r;
                    i++
                )
                    (n = t.attributes[i]),
                        (u.attributes[n.nodeName] = n.nodeValue);
            return (
                (u.find = this.findNodeInJSON),
                (u.findAll = this.findAllNodesInJSON),
                u
            );
        },
        findNodeInJSON: function (t) {
            return (
                Sys.find(this.children, function (e) {
                    return e.tag === t;
                }) || null
            );
        },
        ...
        getMoneyFormatFromXML: function (t, e) {
            var n,
                i,
                r = this.findAll("moneyformat", t);
            for (i = 0, n = r.length; i < n; i++)
                if (this.getNodeValue("iso", r[i]) === e)
                    return this.getMoneyFormatFromNode(r[i]);
            return null;
        },
...
Sys.ns("Sys.utils"),
    (Sys.utils.FunctionQueuer = {
        constructor: function () {
            var e = this;
            Sys.utils.FunctionQueuer.superclass.constructor.apply(
                this,
                arguments
            ),
                (e.q = []),
        ...
        queue: function (e) {
            ...
            Sys.isArray(n) || (n = [n]),
                ...
                (s.length || o.length) && this.createWaiters(t),
                this.q.push(t),
                this.processQueue();
        },
        execute: function (e) {
            ...
            (n.executing = !0),
                (t = function () {
                    n.debug &&
                        console.info(
                            "## function has finished executing in FunctionQueuer! (" +
                                e.event +
                                ")"
                        ),
                        e.obj.removeListener(e.event, t, n),
                        (n.executing = !1),
                        n.processQueue();
                }),
                e.obj.on(e.event, t, n),
                e.fun.apply(e.obj, e.args);
        },
        processQueue: function () {
            var e,
                ...
                n,
                s = this;
            !s.executing && s.q.length
                ? ((t = s.q[0].wos),
                  (n = 0 !== t.waitForObjects.length),
                  (0 === s.q[0].we.length && !n) ||
                  (n && 0 === t.totalEventsCount)
                      ? ((e = s.q.shift()), s.execute(e))
                      : s.debug &&
                        (console.warn(
                            "cannot execute " +
                                s.q[0].event +
                                " since it is waiting for events:"
                        ),
                        console.warn("Event arr: " + s.q[0].we),
                        console.warn("Event obj(s) below: "),
                        Sys.isDefined(s.q[0].wos) && console.info(s.q[0].wos)))
                : s.debug &&
                  (s.q.length
                      ? s.executing &&
                        console.warn(
                            "wont execute " +
                                s.q[0].event +
                                " since FunctionQueuer is already executing!"
                        )
                      : console.warn(
                            "wont execute FunctionQueuer since there are no functions queued!"
                        ));
        },
        createWaiters: function (e) {
            ...
            e.we.length
                ...
                : e.wos.waitForObjects.length &&
                  Sys.each(e.wos.waitForObjects, function (n) {
                      Sys.isArray(n.events) || (n.events = [n.events]),
                          (e.wos.totalEventsCount += n.events.length),
                          t.registerListeners({
                              queueItem: e,
                ...
                var o = function () {
                    n.debug &&
                        console.info(
                            "## " +
                                s +
                                " event was fired in FunctionQueuer, removing it from waiting list!"
                        ),
                        e.waitForEvents.splice(e.waitForEvents.indexOf(s), 1),
                        (t = e.queueItem.wos),
                        Sys.isDefined(t.waitForObjects.length) &&
                            t.totalEventsCount >= 1 &&
                            (t.totalEventsCount -= 1),
                        e.waitForObject.removeListener(s, o, n),
                        n.processQueue();
                };
    ...
    (Sys.utils.FunctionQueuer = Sys.extend(
        Sys.Observable,
        Sys.utils.FunctionQueuer,
        "Sys.utils.FunctionQueuer"
    ));
    ...
    (Loader.ResourceHandler = {
        ...
        preLoad: function () {
            ...
            this.fireEvent("request:loader.show"),
                ...
                t
                    ...
                    .then(function () {
                        return (
                            s.addDynamicPriorityResources(),
                            s.loadResources("priorityList")
                        );
                    })
                    .done(function () {
                        s.fireEvent(
        ...
        determineSessionID: function () {
            var e = Resources.readData("queryData"),
                ...
                s = e.sessId,
                a = e.integration;
            return Sys.isDefined(t) && Sys.isDefined(a)
                ? this.performServletCall(t, a)
                : (Sys.isDefined(s) || Sys.utils.goToLobby("1"),
                  this.storeSessionID(s),
                  null);
        },
        ...
        performServletCall: function (e, t) {
            ...
            return (
                t === this.INTEGRATION
                    ? ("openbet" === t &&
                          ((s = "no-cache=" + Number(Date.now())),
                          (e = Sys.utils.appendParameterToQuery(e, s))),
                      r
                          .when(
                              Sys.utils.httpGet({
                                  url: e,
        ...
        handleServletResponse: function (e) {
            var t = Sys.utils.parseQueryString(e.responseText),
                ...
                r = t.lobbyURL;
            Sys.isDefined(s)
                ? this.storeSessionID(decodeURIComponent(s))
                : Sys.utils.goToLobby("1"),
                Sys.isDefined(a)
                    ? Resources.storeData("pluginURL", decodeURIComponent(a))
                    : this.determinePluginURL(),
            ...
            return (
                s.forEach(function (s) {
                    ...
                    "genericList" === e &&
                        ...
                        "css" === i && t.cssComplete("", s.name, s.url),
                        l
                            .when(
                                Sys.utils.httpGet({
                                    url: n,
        ...
        onLoadResourceError: function (e, t) {
            ...
            if (o && r.lang !== r.defaultLang)
                return (
                    (s = this.getLanguagePath(r.defaultLang, t.type, t.url)),
        ...
        calculatePercentage: function () {
            var e,
                t = this.readData("resources"),
                s = this.readData("totalSize"),
                a = 0;
            Object.keys(t).forEach(function (e) {
                a += t[e];
            }),
                (e = parseInt(Math.min((a / s) * 100, 100), 10)),
                this.storeData("percentageLoaded", e),
        ...
        gameServerInitComplete: function (e) {
            Resources.storeData(
                ...
                Sys.utils.qsToObj(e.responseText)
            ),
                Resources.storeData(
        ...
        priorityAudioJsonComplete: function (e, t) {
            ...
            Platform.resourceBundle.preloadAudio &&
                this.addAudioToGenericList(s),
                Resources.storeData(t, s);
        },
        ...
        getLanguagePath: function (e, t, s) {
            ...
            return (
                "json" === t
                    ? (a = s + this.setCorrectCasing(e) + ".json")
                    : "xml" === t &&
                      (a = "../langlib/" + this.setCorrectCasing(e) + "/" + s),
                a
            );
        },
        ...
        parseResourceXml: function (e) {
            ...
            s.forEach(function (e) {
                e.findAll("resource").forEach(function (e) {
                    ...
                    (c.type = e.find("type").text),
                        (c.url = e.find("url").text),
                        (c.size = Sys.utils.toInt(e.find("size").text)),
                        (c.name = e.find("name").text),
                        (t = e.find("priority")),
                        (s = e.find("resourceTag")),
                        null !== t
                            ? null !== s
                                ? ((l = s.find("type").text),
                                  (u = s.find("key").text),
                                  Sys.isDefined(i[l]) || (i[l] = {}),
                                  (i[l][u] = c))
                                : ((c.priority = t.text), a.push(c))
                            : null !== s
                            ? ((l = s.find("type").text),
                              (u = s.find("key").text),
                              Sys.isDefined(o[l]) || (o[l] = {}),
                              (o[l][u] = c))
                            : (r.push(c), (n += c.size));
                });
            }),
                this.storeData("totalSize", n),
                this.storeData("priorityList", a),
        ...
        buildHistoryUrl: function () {
            ...
            return (
                ...
                Platform.isMQQBrowser && (t += "&type=mobile"),
                t
            );
        },
        readData: function (e) {
...
Sys.ns("Core"),
    (Core.LoaderController = {
        ...
        tick: function () {
            ...
            t !== i &&
                (this.model.storeData("visualPercentage", i),
        ...
        hideDialog: function () {
            this.fireEvent("notify:loader.confirmDialogClosed"),
                ...
                100 === this.model.readData("visualPercentage") &&
                    this.showDialogFromQueue();
        },
...
Sys.ns("Core"),
    (Core.LoaderView = {
        ...
        createDialog: function (e) {
            ...
            return (
                a.classList.add("loader-dialog"),
                e
                    ? (r.classList.add("loader-dialog__message"),
                      i.classList.add("loader-dialog__button-group"),
                      ...
                      (e.buttons || []).map(function (e) {
                          var t = new Interface.utils.Button(
                              Sys.apply(e, {
    ...
    (Loader.ErrorHandler = {
        ...
        handleRequestError: function (e) {
            ...
            Sys.utils.httpRequestIsOK(e)
                ? Sys.isDefined(r)
                    ? ((t = "server"), 20 === r && Sys.utils.goToLobby("1"))
                    : Sys.utils.goToLobby("1")
                : (t = "http"),
                Sys.isDefined(t) &&
                    t !== this.readStatus() &&
                    (this[this.errorStatus[t]](), this.setStatus(t));
        },
        ...
        getTexts: function (e) {
            ...
            for (r = -1; ++r < e.length; )
                (t = e[r]),
                    a.push(
                        Services.languageManager.hasText(t.key)
                            ? Services.languageManager.getText(t.key)
                            : t.fallback
                    );
            return a;
        },
...
Sys.isDefined(Loader.ErrorHandler) &&
    ...
    Sys.override(Loader.ErrorHandler, {
        ...
        handleRequestError: function (e) {
            ...
            Sys.utils.httpRequestIsOK(e)
                ? Sys.isDefined(a)
                    ? ((r = "server"), 20 === a && (r = "timeout"))
                    : (r = "server")
                : (r = "http"),
                Sys.isDefined(r) &&
                    r !== t.readStatus() &&
                    (t[t.errorStatus[r]](), t.setStatus(r));
        },
        setupDialogButtons: function () {
            return [
                {
...
Sys.ns("Loader"),
    (Loader.originalSetLanguageOfHtmlTag =
        Loader.ResourceHandler.prototype.setLanguageOfHtmlTag),
    Sys.apply(Loader.ResourceHandler.prototype, {
        setLanguageOfHtmlTag: function (e) {
            Loader.originalSetLanguageOfHtmlTag.call(this, e),
                Loader.FontLoader.init();
        },
    }),
    Loader.ResourceHandler &&
        Sys.override(Loader.ResourceHandler, {
            ...
            jsonComplete: function (e, a) {
                var r, o;
                "configDesktop" === a && Platform.isDesktopDevice
                    ? Sys.isDefined(Resources.readData("config")) &&
                      ((r = Resources.readData("config")),
                      (o = JSON.parse(e.responseText)),
                      this.copyProperties(o, r))
                    : Resources.storeData(a, JSON.parse(e.responseText));
            },
            copyProperties: function (e, a) {
                Sys.iterate(e, function (e, r) {
                    Sys.isDefined(a[e]) || (a[e] = {}),
                        Sys.isObj(r)
                            ? Sys.applyProperties(a[e], r)
                            : (a[e] = r);
                });
            },
        });
    ...
    (Loader.FontLoader = {
        ...
        attachFontStyles: function () {
            var t,
                e = this,
                n =
                    e.NON_LATIN_LANG.indexOf(document.documentElement.lang) >
                    -1,
                a = document.createElement("style"),
                o = "";
            e.FONTS.forEach(function (a) {
                (t = n && e.FALLBACK[a.name] ? e.FALLBACK[a.name] : a),
                    (o += e.createFontCSS(
                        a.name,
                        t.location,
                        t.path,
    ...
    (Integration.OpenBetResourceHandlerOverride = {
        ...
        handleServletResponse: function (e) {
            var t = this,
                ...
                o = r.pluginURL;
            (n["openbet.rgitoken"] = r.rgitoken),
                (n["openbet.user_id"] = a["openbet.user_id"]),
                (n["openbet.game_code"] = a["openbet.game_code"]),
                (n["openbet.channel"] = t.getOpenBetChannel()),
                (n["openbet.user_type"] = a["openbet.user_type"]),
                (n["openbet.affiliate"] = Sys.isDefined(a["openbet.affiliate"])
                    ? a["openbet.affiliate"]
                    : ""),
                (n["openbet.rgs_site"] = "NetEnt site"),
                (n["openbet.promotions"] = "NO"),
                Sys.applyIf(Resources.readData("extraParams"), n),
...
Sys.ns("Integration.GCM"),
    ...
    (window.setViewportHidden = function (e) {
        var t,
            n = document.getElementById("viewport");
        null !== n &&
            Sys.isDefined(n) &&
            ((t = 1), e && (t = 0.01), (n.style.opacity = t));
    }),
    (Integration.GCM.Proxy = {
        ...
        constructor: function () {
            var e,
                t,
                n = this;
            Integration.GCM.Proxy.superclass.constructor.call(n),
                Sys.override(Loader.ResourceHandler, {
        ...
        setupAccount: function () {
            var e = Resources.readData("gameServerInitResponse"),
                ...
                n = Sys.utils.XMLHelper.getMoneyFormatFromXML(
                ...
                o =
                    (Sys.isDefined(e["openbet.freebets"])
        ...
        processServerResponse: function (e) {
            var t = this,
                n = e.openbet;
            (t.freeBetBalance =
                Sys.isDefined(n) && Sys.isDefined(n.freebets)
                    ? Number(n.freebets)
                    : t.freeBetBalance),
                (t.latestWin = Sys.isDefined(e.wins) ? e.wins.centsTotal : 0);
        },
        onShowWin: function () {
        ...
        onSettingChanged: function (e) {
            "betLevel" === e || "denomination" === e || "betLines" === e
                ...
                : "volume" === e && this.updateAudioSettingInUI();
        },
        ...
        updateTurboSettingInUI: function () {
            ...
            e.hasRegisteredOptions &&
                ...
                e.gcmCoreInstance.optionHasChanged("TURBO", "GAME", t);
        },
        updateAudioSettingInUI: function () {
            ...
            e.hasRegisteredOptions &&
                ...
                e.exposedInterface.toggleMute(t);
        },
        handleError: function (e) {
            ...
            i.disableUI(),
                (t = !0),
                e.RGIError
                    ? ((n = com.openbet.gcm.xmlutil),
                      (a = n.getErrorInfoFromRGIXml(
        ...
        configReady: function () {
            var e = this,
                t = !e.isDemoMode();
            (t && Sys.openBetMode) || (!t && !Sys.openBetMode)
                ? initializeGame({
        ...
        simulateLoading: function (e) {
            ...
            t < 100
                ? this.gcmCoreInstance.loadProgressUpdate(t)
        ...
        optionHasChanged: function (e, t) {
            ...
            switch (e) {
                ...
                case "GAME_PREFERENCES":
                    Platform.isDesktopDevice
                        ? n.toggleSettingsWindowDesktop("gameSettings")
                        : n.toggleSettingsWindow(t, "betSettings");
                    break;
                case "PAYTABLE":
        ...
        toggleSettingsWindow: function (e, t) {
            this.basicGamePanelEnabled &&
                (e
                    ? this.fireEvent("request:" + t + ".show")
        ...
        toggleQuickSpin: function (e) {
            var t;
            this.fireEvent("request:settingsManager.storeData", "quickSpin", e),
                (t = Services.settingsManager.getSetting("quickSpin")) !== e &&
                    this.gcmCoreInstance.optionHasChanged("TURBO", "GAME", t);
        },
        balancesHasChanged: function (e) {
            var t, n;
            this.inIdleState
                ? ((t = parseInt(Math.round(100 * e.CASH.amount), 10)),
                  (n = parseInt(Math.round(100 * e.FREEBET.amount), 10)),
                  Services.moneyManager.setBalance(t + n),
                  (this.freeBetBalance = n))
                : Sys.utils.reload();
        },
        ...
        resume: function (e) {
            ...
            try {
                i &&
                    1 === n.actionsOfCurrentDialog.length &&
                    !Sys.isDefined(a) &&
                    (a = 0),
                    i && Sys.isDefined(n.actionsOfCurrentDialog[a])
                        ? n.actionsOfCurrentDialog[a]()
                        : n.shouldRevertRound &&
                          (n.fireEvent("request:moneyManager.revertBet"),
                          n.fireEvent(
            ...
            n.multiChoiceGameDialogsQueue.length > 0
                ? ((t = n.multiChoiceGameDialogsQueue.shift()),
                  n.handleError(t))
                : ((n.exclusivityEnable = !1),
                  n.fireEvent(
                      "request:userInputManager.deactivateExclusivity",
                      n.MODULE_NAME
                  ),
