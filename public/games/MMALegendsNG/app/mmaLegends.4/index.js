...
$jscomp.scope = {}, $jscomp.arrayIteratorImpl = function(t) {
    ...
    function(t) {
        ...
        o.e = function(t) {
            ...
            if (0 !== n)
                if (n) e.push(n[2]);
                    ...
                    s.charset = "utf-8", s.timeout = 120, o.nc && s.setAttribute("nonce", o.nc), s.src = o.p + "games/MMALegendsNG/app/mmaLegends.4/" + ({
                        0: "game",
                        2: "vendors~vendor"
                    } [t] || t) + ".js";
                    var c = Error(),
        ...
        window.WEBPACK = !0, window.WEBPACK_VERSION = 1, window.GAMECODE = "278", window.MODE = "production", window.gameVersion = "(build 4 commit 933b199fdf3724a859f186098049c63581b277f1)", window.loadPackedVendorBundles = function() {
