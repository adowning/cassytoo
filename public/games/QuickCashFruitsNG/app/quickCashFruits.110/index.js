...
$jscomp.scope = {}, $jscomp.arrayIteratorImpl = function(t) {
    ...
    function(t) {
        ...
        o.e = function(t) {
            ...
            if (0 !== n)
                if (n) e.push(n[2]);
                    ...
                    s.charset = "utf-8", s.timeout = 120, o.nc && s.setAttribute("nonce", o.nc), s.src = o.p + "games/QuickCashFruitsNG/app/quickCashFruits.110/" + ({
                        0: "game",
                        2: "vendors~vendor"
                    } [t] || t) + ".js";
                    var c = Error(),
        ...
        window.WEBPACK = !0, window.WEBPACK_VERSION = 1, window.GAMECODE = "353", window.MODE = "production", window.JURISDICTION = "other", window.gameVersion = "(build 110 commit 0ea3a2099828bf62434f3bbaaae88a9b248368ec)", window.loadPackedVendorBundles = function() {
