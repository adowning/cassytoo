...
$jscomp.scope = {}, $jscomp.arrayIteratorImpl = function(t) {
    ...
    function(t) {
        ...
        o.e = function(t) {
            ...
            if (0 !== n)
                if (n) e.push(n[2]);
                    ...
                    s.charset = "utf-8", s.timeout = 120, o.nc && s.setAttribute("nonce", o.nc), s.src = o.p + "games/WildBuffaloNG/app/buffalo.10/" + ({
                        0: "game",
                        2: "vendors~vendor"
                    } [t] || t) + ".js";
                    var c = Error(),
        ...
        window.WEBPACK = !0, window.WEBPACK_VERSION = 1, window.GAMECODE = "190", window.MODE = "production", window.gameVersion = "(build 10 commit 65b32eb68802b05765d17f437203f79b544742f5)", window.loadPackedVendorBundles = function() {
