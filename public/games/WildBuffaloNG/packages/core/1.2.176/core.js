...
$jscomp.scope = {}, $jscomp.ASSUME_ES5 = !1, $jscomp.ASSUME_NO_NATIVE_MAP = !1, $jscomp.ASSUME_NO_NATIVE_SET = !1, $jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(e, t, n) {
    ...
    function(e) {
        ...
        n(1), n(2), n(9), n(177), n(202), n(216), window.nge._versions = window.nge._versions || {}, window.nge._versions.core = JSON.stringify("1.2.176") || "local"
    }, function(e, t) {
        ...
        nge.Com.Balance.Controller = nge.Com.Base.extend((function() {
            ...
            this.create = function() {
                ...
                return n && t._drawText(n), e || t._subscribe(), e = !0
            }, this._change = function(e) {
                if ("object" != typeof e) return !1;
                var n = nge.localData.get("totalBet.value");
                return e.totalAmount < n && (nge.observer.fire("spinButton.disable"), nge.observer.fire("autospinButton.disable"), nge.observer.fire("pokerButton.disable"), nge.observer.fire("kenoButton.disable"), nge.observer.fire("infoPanel.show", "NOT ENOUGH MONEY TO SPIN")), t._drawText(e), nge.localData.set("balance.totalAmount", e.totalAmount), !0
            }, this._drawText = function(e) {
                var t, n = nge.findAll(".balanceNumber");
                for (t in n) n[t].text = parseFloat(e.totalAmount).toFixed(2);
                if (e.currency)
                    for (t in n = nge.findAll(".currency")) n[t].text = e.currency
            }, this._subscribe = function() {
                nge.observer.add("balance.amount", t._change)
            }
        }))
    }, function(e, t) {
        ...
        nge.Com.ClusterHighlighter = {}
    }, function(e, t) {
        nge.Com.ClusterHighlighter.Cfg = Class.extend((function() {
            this.singleton = !0, this.sprites = {
                direction0: ["vertical_lightning0", "vertical_lightning1", "vertical_lightning2", "vertical_lightning3"],
                direction1: ["horizontal_lightning0", "horizontal_lightning1", "horizontal_lightning2", "horizontal_lightning3"],
                direction2: ["horizontal_lightning0", "horizontal_lightning1", "horizontal_lightning2", "horizontal_lightning3"],
                direction3: ["vertical_lightning0", "vertical_lightning1", "vertical_lightning2", "vertical_lightning3"]
            }, this.nodeType = "GraphicsNode", this.assetKey = "border_skeleton", this.lineWidth = 10, this.lineColor = 5636095, this.figureType = "rectangle", this.figureBounds = {
                hexagon: function(e, t) {
                    return {
                        point0: {
                            x: -34,
                            y: -54
        ...
        nge.Com.ClusterHighlighter.Controller = nge.Com.Base.extend((function() {
            var e, t, n, i, o = this;
            this.create = function() {
                o.createDefault(), t = o.getInstance("Cfg"), (n = o.getInstance("View")).init(t), i = [], e || o.subscribe()
            }, this.setNewQuery = function(e) {
                if (e.slotWin && e.slotWin.lineWinAmounts) {
                    e = e.slotWin.lineWinAmounts, i = [];
                    for (var t = (e = $jscomp.makeIterator(e)).next(); !t.done; t = e.next())
                        for (var n = {}, o = (t = $jscomp.makeIterator(t.value.wonSymbols)).next(); !o.done; n = {
                                x: n.x,
                                y: n.y
                            }, o = t.next()) o = o.value, n.x = parseInt(o[0], 10), n.y = parseInt(o[1], 10), 0 === i.filter(function(e) {
                            return function(t) {
                ...
                n.show(i)
            }, this.animateByOne = function() {}, this.stopAnimation = function() {
                n.hideAll()
            }, this.subscribe = function() {
                nge.observer.add("slotMachine.spinStart", o.stopAnimation), nge.observer.add("winlines.pauseAnimation", o.stopAnimation), nge.observer.add("winlines.stopAnimation", o.stopAnimation), nge.observer.add("slotMachine.spinResponse", o.setNewQuery), nge.observer.add("winlines.setNewQuery", o.setNewQuery), nge.observer.add("winlines.animateAll", o.animateAll), nge.observer.add("winlines.animateByOne", o.animateByOne), e = !0
            }, this.destroy = function() {}
        }))
    }, function(e, t) {
        nge.Com.ClusterHighlighter.GraphicsNode = nge.Com.Base.extend((function() {
            var e = this;
            this.init = function(t) {
                e.container = t.container, e.points = t.points, e.figure = t.figure, e.directions = t.directions, e.lineWidth = t.lineWidth, e.lineColor = t.lineColor, e.graphics = nge.objects.create(new nge.Mlm.Objects.Graphics({})), e.container.addChild(e.graphics)
            }, this.toggle = function(t) {
                for (var n in e.graphics.clear(), e.graphics.lineStyle(e.lineWidth, e.lineColor), e.directions)
                    if (!0 === t[n]) {
                        var i = e.directions[n],
                            o = e.points[i[0]];
                        i = e.points[i[1]], e.graphics.moveTo(o.x, o.y), e.graphics.lineTo(i.x, i.y)
                    }
            }
        }))
    }, function(e, t) {
        nge.Com.ClusterHighlighter.TextureNode = nge.Com.Base.extend((function() {
            var e = this;
            this.init = function(t) {
                for (var n in e.container = t.container, e.points = t.points, e.figure = t.figure, e.directions = t.directions, e.sprites = {}, e.directions) {
                    var i = nge.objects.create(new nge.Mlm.Objects.Animation({
                            frames: t.sprites[n],
                            loop: !0,
                            autoStart: !0,
                            speed: .2
                        })),
                        o = (e.points[e.directions[n][0]].x + e.points[e.directions[n][1]].x) / 2,
                        s = (e.points[e.directions[n][0]].y + e.points[e.directions[n][1]].y) / 2;
                    i.anchor.set(.5, .5), i.position.set(o, s), i.visible = !1, e.sprites[n] = i, e.container.addChild(i)
                }
            }, this.toggle = function(t) {
                for (var n in e.directions) e.sprites[n].visible = t[n]
            }
        }))
    }, function(e, t) {
        nge.Com.ClusterHighlighter.SpineNode = nge.Com.Base.extend((function() {
            var e = this;
            this.init = function(t) {
                e.container = t.container, e.points = t.points, e.figure = t.figure, e.directions = t.directions, e.tracks = {};
                for (var n = Object.keys(e.directions), i = 0; i < n.length; i++) e.tracks[n[i]] = i;
                e.animation = nge.objects.create(new nge.Mlm.Objects.Spine({
                    assetKey: t.assetKey,
                    anchorX: .5,
                    anchorY: .5
                })), e.container.addChild(e.animation)
            }, this.toggle = function(t) {
                for (var n in e.animation.stop(), e.directions) t[n] && e.animation.setAnimationByName(e.tracks[n], n, !0)
            }
        }))
    }, function(e, t) {
        nge.Com.ClusterHighlighter.Helper = function() {
            this.singleton = !0, this.borderLines = {
                hexagon: function(e, t) {
                    return {
                        direction0: ["point0", "point1"],
                        direction1: ["point1", "point2"],
                        direction2: ["point2", "point3"],
                        direction3: ["point3", "point4"],
                        direction4: ["point4", "point5"],
                        direction5: ["point5", "point0"]
                    }
                },
                rectangle: function(e, t) {
                    return {
                        direction0: ["point0", "point3"],
                        direction1: ["point0", "point1"],
                        direction2: ["point3", "point2"],
                        direction3: ["point1", "point2"]
                    }
                },
                triangle: function(e, t) {
                    return {
        ...
        nge.Com.ClusterHighlighter.Tpl = function() {
            ...
            return {
                assets: {
                    ...
                    contents: [{
                        type: mt.assets.IMAGE,
                        key: "horizontal_lightning0",
                        fullPath: e + "lightning_horizontal0.png"
                    }, {
                        type: mt.assets.IMAGE,
                        key: "horizontal_lightning1",
                        fullPath: e + "lightning_horizontal1.png"
                    }, {
                        type: mt.assets.IMAGE,
                        key: "horizontal_lightning2",
                        fullPath: e + "lightning_horizontal2.png"
                    }, {
                        type: mt.assets.IMAGE,
                        key: "horizontal_lightning3",
                        fullPath: e + "lightning_horizontal3.png"
                    }, {
                        type: mt.assets.IMAGE,
                        key: "vertical_lightning0",
                        fullPath: e + "lightning_vertical0.png"
                    }, {
                        type: mt.assets.IMAGE,
                        key: "vertical_lightning1",
                        fullPath: e + "lightning_vertical1.png"
                    }, {
                        type: mt.assets.IMAGE,
                        key: "vertical_lightning2",
                        fullPath: e + "lightning_vertical2.png"
                    }, {
                        type: mt.assets.IMAGE,
                        key: "vertical_lightning3",
                        fullPath: e + "lightning_vertical3.png"
                    }, {
                        type: mt.assets.SPINE,
                        key: "border_skeleton",
                        spine: e + "spine/skeleton.json"
                    }]
                },
                objects: {
                    name: "objects",
        ...
        nge.Com.ClusterHighlighter.View = Class.extend((function() {
            var e, t = this;
            this.helper = this.nodes = this.root = null, this.buildNodes = function() {
                t.nodes = [], t.root = nge.objects.create(new nge.Mlm.Objects.Folder({}));
                for (var n = t.getInstance("Cfg", "slotMachine").get(), i = n.mhv ? n.mhv.length : n.mw, o = [], s = [], a = 0; a < i; a++) o.push(n.mhv && n.mhv[a] ? n.mhv[a] : n.mh), s.push(n.rowsYoffset && n.rowsYoffset[a] ? n.rowsYoffset[a] : 0);
                var r = t._container.getData();
                for (a = r.width / n.mw, n = r.height / n.mh, r = 0; r < i; r++) {
                    for (var l = [], c = 0; c < o[r]; c++) {
                        var u = nge.objects.create(new nge.Mlm.Objects.Folder({})),
                            g = t.getInstance(e.nodeType);
                        g.init({
                            container: u,
                            ...
                            figure: e.figureType,
                            sprites: e.sprites,
                            points: e.figureBounds[e.figureType](r, c),
                            directions: t.helper.borderLines[e.figureType](r, c)
                        }), t.root.addChild(u), u.position.set(r * a, s[r] + c * n), l.push(g)
                    }
                    t.nodes.push(l)
                }
                t._container.addChild(t.root)
            }, this.init = function(n) {
                e = n, t._container = nge.findOne("^clusterHighlighterContainer"), t.helper = new nge.Com.ClusterHighlighter.Helper, t.buildNodes()
            }, this.show = function(n) {
                for (var i = $jscomp.makeIterator(n), o = i.next(); !o.done; o = i.next()) {
                    var s = o.value;
                    o = t.nodes[s.x][s.y], s = t.helper.getNeighbours[e.figureType](s.x, s.y);
                    for (var a = Object.keys(s), r = {}, l = {}, c = (a = $jscomp.makeIterator(a)).next(); !c.done; l = {
                            neighbour: l.neighbour
                        }, c = a.next()) c = c.value, l.neighbour = s[c], r[c] = 0 === n.filter(function(e) {
                        return function(t) {
                            return t.x === e.neighbour.x && t.y === e.neighbour.y
                        }
                    }(l)).length;
                    o.toggle(r)
                }
            }, this.hide = function(e) {
                for (var n = (e = $jscomp.makeIterator(e)).next(); !n.done; n = e.next()) n = n.value, t.nodes[n.x][n.y].toggle({})
            }, this.hideAll = function() {
                for (var e = 0; e < t.nodes.length; e++)
                    for (var n = 0; n < t.nodes[e].length; n++) t.nodes[e][n].toggle({})
            }
        }))
    }, function(e, t) {
        nge.Com.Coins = {}
        ...
        nge.Com.Debug.RenderStat = Class.extend((function() {
            ...
            this._fillRenderStat = function(e, n) {
                e.mt && e.mt.data && (e.mt.data.type === mt.objects.TEXT ? e.visible && (n.pxText += Math.abs(e.width * e.height), n.nText++) : e.mt.data.type === mt.objects.BITMAP_TEXT ? e.visible && (n.pxText += Math.abs(e.width * e.height), n.nText++) : e.mt.data.type === mt.objects.IMAGE && "_slotMachineBlur" !== e.mt.data.class || e.mt.data.type === mt.objects.GRAPHICS || e.mt.data.type === mt.objects.ANIMATION ? e.visible && (n.pxSprite += Math.abs(e.width * e.height), n.nSprite++, e.vertexData && (n.nVertices += e.vertexData.length / 2)) : e.mt.data.type !== mt.objects.MASK && (e.mt.data.type === mt.objects.BUTTON ? e.visible && (n.pxSprite += Math.abs(e.width * e.height), n.nSprite++, e.vertexData && (n.nVertices += e.vertexData.length / 2)) : e.mt.data.type === mt.objects.NINE_SLICE ? e.visible && (n.pxSprite += Math.abs(e.width * e.height), n.nSprite++, e.vertices && (n.nVertices += e.vertices.length)) : PIXI && PIXI.spine && e instanceof PIXI.spine.SpineMesh ? e.visible && (n.pxSprite += Math.abs(e.width * e.height), n.nMesh++, n.nVertices += e.vertices.length / 2) : e.mt.data.type === mt.objects.GROUP ? e.visible && (n.containers++, e.children.forEach((function(e) {
        ...
        nge.Com.Load.Controller = nge.Com.Base.extend((function() {
            var e, t;
            this.preload = function() {
                t = this, this.preloadDefault(), e = this.getInstance("Cfg"), t._auth(), nge.userInfoHTML("Preloading fonts and sounds"), "_src" !== nge.localData.get("settings.imageQuality") && t._preloadUber(), t._preloadFonts(), t._preloadCustomJs()
            }, this.create = function() {
        ...
        nge.Com.Paytable.Controller = nge.Com.Base.extend((function() {
            ...
            this.preload = function() {
                ...
                var h = i % o;
                for (var m in l = (o * s - h * s) / 2, t) {
                    var d = t[m].awards,
                        y = nge.objects.create("paytableItemContainer", e);
                    y.visible = !0, y.id = m + "_itemContainer", y.name = m + "_itemContainer", y.x = r, y.y = c, u > i - h && (y.x += l), (g = y.create(0, 0, m)).id = m + "_logo", g.name = m + "_logo", g.width = p, g.height = b;
                    var _ = 0;
                    d.forEach((function(e) {
                        ...
                        n.y = _, n.text = e.name, n.visible = !0, (t = nge.objects.create("paytableAwardValue", t)).name = "paytableAwardValue" + e + m, t.y = _, t.text = "- " + e.value, t.visible = !0, _ += 50
        ...
        nge.Com.Respin.Controller = nge.Com.Base.extend((function() {
            ...
            this._restoringFlag = !1, this.create = function() {
                ...
                n = !1, e._spinCommand()
            }, this.spinCommand = this._spinCommand = function() {
                if (!s || n) return !1;
        ...
        nge.Com.SlotMachine.RecyclerReel = nge.Com.Base.extend((function() {
            ...
            this.init = function(t) {
                ...
                t = void 0 !== t && t;
                for (var n = 0; n < e._borderSymbolsCount; n++) e._symbols[n].texture.visible = t, e._symbols[e._symbols.length - (n + 1)].texture.visible = t
            }
        }))
    }, function(e, t) {
        nge.Com.SlotMachine.RecyclerView = Class.extend((function() {
            ...
            this._service = this._cfg = null, this._symbols = {}, this._helper = null, this._symbolSize = {
                ...
                console.color("[RV]deactivate", "#00ff00", "#000000"), e._holdedSymbolsContainer && (e._holdedSymbolsContainer.destroy(), e._holdedSymbolsContainer = null)
            }, this.destroy = function() {
                for (var t = 0; t < e._reels.length; t++) e._reels[t].destroy();
                e._reels = []
            }, this.destroyReelsContainer = function() {
                console.color("[RV]destroyReelsContainer", "#ff0000", "#000000"), e._reelsContainer.destroy(), e.destroy()
        ...
        nge.Com.SlotMachine.Service = Class.extend((function() {
            ...
            this._cfg = this._view = null, this.init = function() {}, this.preload = function() {
                ...
                return !(a && !n) && (e._view.showAnimationSymbolsCover(t), !(!(t = e._view.getSymbolByPosition(t)) || !t.animate) && (t.animate(), (t = t.getConfig()).winlineTime && nge.observer.fire("winlines.setCurrentLineDurationFirstTime", t.winlineTime, 1), !0))
        ...
        nge.Com.SlotMachine.SymbolBase = Class.extend((function() {
            ...
            this._originalParams = {}, this._subscribed = this._animationCreated = !1, this._spritesList = [], this._frames, this._name, this._repeat, this._animateNonStop, this._frameTime, this._initialScale = {
                ...
                return e._symbolConfig.animationRelaunchOnWinlinesCycle && e._cancelAnimation(), void 0 !== e._texture && void 0 !== e._texture.parent && e._texture && e._texture.parent ? (e._subscribed || e._subscribe(), e._animationCreated || e._animationCreate(), e._subscribed = !0, e._animationCreated = !0, e.textureAnimationShow(t), e._tween || e._createTween(), e._tween.start(), e._symbolConfig.animateAllWinlinesCycle && (e._animateNonStop = !0), !0) : (console.warn("nge.Com.SlotMachine.Symbol.animate error", e._symbolConfig), !1)
                ...
                e._frames = t, e._tween = nge.tween.add({
                    x: 0
                }), e._tween.enableUpdate = !0, t = e._repeat;
                for (var o = 0; o < t; o++) e._tween.to({
                    x: i
                }, i * n);
                return e._tween.onUpdateCallback((function(t, n, i) {
                    e._textureAnimation.loadTexture(e._frames[~~(i.percent * i.vEnd.x)])
                ...
                for (e._tween = nge.tween.add({
                        x: 0
                    }), e._tween.enableUpdate = !0, e._symbolConfig.animationMainTextureNeed || (e._textureAnimation.loadTexture(e._frames[0].spriteName), e._textureAnimation.frame = 0), s = e._repeat, i = 0; i < s; i++) e._tween.to({
                    x: n
                }, n * t);
                return e._tween.onUpdateCallback((function(t, n, i) {
        ...
        nge.Com.SlotMachine.View = Class.extend((function() {
            ...
            this._cfg, this._pool, this._symbolSize, this._reelsSymbols, this._speedReelsCustom = [], Object.defineProperties(this, {
                ...
                C = e || "forward", v = h = !1, l._speedReelsCustom = [], l._setNewReelsCfg(!1), e = !1;
                ...
                g = [], c = 0, v = m = !1, l._pool && !t && l._pool.reset()
                ...
                if (i) {
                    var b = nge.tween.add(e, "custom" === l._cfg.tweenType),
                        h = l.customReelStartCallback(e, t, b, a);
                    h && (b = h.tween, a = h.startDelay), g[t] = b
                }
                h = "forward" === C ? n.height + p : -n.height + p;
                return i && "linear" === s.animationType ? (s = (n.height + l._symbolSize.height * o) / (u - c), f[t] = s, b.to({
                    ...
                    y: h
                }, r, nge.Lib.Tween.Easing.Linear.None, !1) : e.y = h), i ? (b.onStart.addOnce((function() {
                ...
                if (!m)
                    for (m = [], n = 0; n < l._cfg.mw; n++) m[n] = 0;
                var i = nge.localData.get("slotMachineIntrigue");
                if (r && i && i.status && !i.done) {
                    nge.localData.set("slotMachineIntrigue.done", !0);
                    var o = 1;
                    for (n = i.startsFrom; n < l._cfg.mw; n++) m[n] += 5 * o, o++;
                    v = !0
                }
                if (o = nge.localData.get("slotMachineAdditionalBlurs"), r && o)
                    for (n = 0; n < o.length; n++) o[n] && (m[n] += o[n]), 0 > m[n] && (m[n] = 0);
                if (nge.localData.set("slotMachineAdditionalBlurs", !1), r && (h || 0 >= m[t])) return l._reelSpinsFinish(t), !1;
                if (0 === t && 0 === m[0])
                    for (n = 0; n < l._cfg.mw; n++) m[n]++;
                if (m[t]--, !h && v && !l._speedReelsCustom[t] && g[t - 1] && !g[t - 1].isRunning)
                ...
                if (b[t] || (b[t] = []), n = nge.localData.get("slotMachineAdditionalBlursKeys"), i = "blurTemp", r && n && n[t] && n[t][m[t]] && (i = n[t][m[t]]), !(i = l._pool.release(i))) return !1;
                ...
                c++, l.customReelStopCallback(e, t), c === l._reelsSymbols.length && (g = [], c = 0, v = m = !1, nge.rafSetTimeout((function() {
                ...
                var a = 1;
                l._speedReelsCustom[t] ? a = l._speedReelsCustom[t] : h && (a = l._cfg.speedUpReelsFactor), "custom" === l._cfg.tweenType ? s = g[t] : (s = nge.tween.add(e), g[t] = s), "linear" === o.animationType ? s.to({
                    y: i
        ...
        nge.Com.Winlines.View = Class.extend((function() {
            ...
            this.create = function() {
                ...
                if (!1 !== g._cfg.rowsIndexesNormalizeValue && (h = g._cfg.rowsIndexesNormalizeValue), !1 !== h) return h;
                if (!t) return !1;
                for (var e = 0; e < t.length; e++)
                    for (var n = 0, i = t[e].length; n < i; n++) h = h > t[e][n] ? t[e][n] : h;
                return h
                ...
                if (l.width = 1920, l.height = 1080, c.translate(i.x, 0), g._cfg.buildWinLines)
                    for (var u = 0; u < t.length; u++) {
                        ...
                        var b = 0;
                        if (g._cfg.shadow) {
                            var h = g._cfg.stroke ? g._cfg.stroke.weight + g._cfg.lineWeight : g._cfg.lineWeight;
                            b = ++h + 4, g._drawLine(t[u], u, c, h, "0x000000", .2)
                        }
                        g._cfg.stroke && (g._drawLine(t[u], u, c, g._cfg.stroke.weight + g._cfg.lineWeight, g._cfg.stroke.colors[u], g._cfg.stroke.alpha), b = b || g._cfg.stroke.weight + g._cfg.lineWeight), g._drawLine(t[u], u, c, g._cfg.lineWeight, g._cfg.lineColors[u]), b = b || g._cfg.lineWeight, b = g._cutLine(t[u], u, c, b), (h = nge.objects.create(new nge.Mlm.Objects.Folder({
                            name: "winline_" + u
                        }))).visible = !1, h.add(b), n.push(h), g._cfg.cacheLineObjectsAsBitmap && (b.cacheAsBitmap = !0), r.add(h), g._cfg.numbers && (h = g._createLineNumber(u), o.add(h), f.push(h), u < p && g._highlightLineNumber(u)), nge.localData.get("winlines.updated") && u < p && this.show(u)
                    }
                ...
                for (t = 0, r = e.length; t < r; t++) 0 === t ? p(d = c / 2 - f, y = e[0] * u + u / 2 + b, h = c / 2, m = y, !0) : p(d, y, h = t * c + c / 2, m = e[t] * u + u / 2 + b), d = h, y = m;
                return p(d, y, h + f, m), l
            }, this.show = function(e) {
                ...
                this.hideAll(), void 0 !== b[r].selectedLine && g._cfg.showLinesOnWin && this.show(b[r].selectedLine), nge.observer.fire("winlines.lineHighlite.start.previousHided", b[r]), g._animateSymbols(b[r].wonSymbols), m = !1, l = nge.rafSetTimeout(g._animationOneByOneCallback, g._cfg.animationOneByOneDuration), u = "OneByOne", nge.observer.fire("winlines.lineHighlite.startComplete", b[r])
            }, this.sendLineToBack = function(e) {
                i.sendToBack(n[e])
            }, this.setCurrentLineDuration = function(e, t) {
                if (t && m) return !1;
                l && (m = !0, nge.rafClearTimeout(l), l = nge.rafSetTimeout("All" === u ? g._animationAllCallback : g._animationOneByOneCallback, e))
                ...
                0 === g._cfg.animationAllDuration && g._animateAllDone(), r = 0, m = !1, l = nge.rafSetTimeout(g._animationAllCallback, g._cfg.animationAllDuration), u = "All";
                ...
                if (l = g._cfg.lineCustomCoords[t])
                    for (e = !0, t = 0; t < l.length; t++) {
                        ...
                        for (t = 0, l = e.length; t < l; t++) 0 === t ? p(d = c / 2 - f, y = e[0] * u + u / 2 + b, h = c / 2, m = y, !0) : p(d, y, h = t * c + c / 2, m = e[t] * u + u / 2 + b), d = h, y = m;
                        p(d, y, h + f, m)
                    }
        ...
        n(178), n(179), n(180), n(181), n(182), n(184), n(185), n(186), n(187), n(188), n(189), n(190), n(191), n(192), n(193), n(194), n(195), n(196), n(197), n(198), n(199), n(200), n(201)
    }, function(e, t) {
        nge.Lib = {}
    }, function(e, t) {
        ...
        function a() {
            b && f && (b = !1, f.length ? p = f.concat(p) : h = -1, p.length && r())
        }
        ...
        "undefined" == typeof nge && (nge = {}), nge.Lib || (nge.Lib = {}), nge.Lib.Helper = {
            ...
            jsObjClone: function(e) {
                if (!e || "object" != typeof e) return e;
                var t, n = "function" == typeof e.pop ? [] : {};
                if (e.hasOwnProperty)
                    for (t in e)
                        if (e.hasOwnProperty(t)) {
                            var i = e[t];
                            n[t] = "imageSrc" === t ? i : i && "object" == typeof i ? nge.Lib.Helper.jsObjClone(i) : i
                        } return n
            },
            ...
            createPng: function(e, t, n, i, o, s, a) {
                return s || (s = 255), n = new function(e, t, n, i) {
                    return this.red = parseInt(e) % 256, this.green = parseInt(t) % 256, this.blue = parseInt(n) % 256, this.alpha = parseInt(i) % 256, this
                }(n, i, o, s), n = String.fromCharCode(n.red, n.green, n.blue, n.alpha), e = "data:image/png;base64," + btoa(nge.generatePng(e, t, n)), a ? e : ((a = new Image).src = e, a)
            },
            ...
            objectApply: function(e, t) {
                for (var n in t) {
                    var i = t[n];
                    e[n] ? "array" == typeof i || "object" == typeof i ? e[n] = nge.Lib.Helper.objectApply(e[n], t[n]) : t[n] !== e[n] && (e[n] = i) : e[n] = i
                }
                return e
            },
        ...
        nge.Lib.Observer = function() {
            ...
            this.add = function(i, s, r, l) {
                ...
                if ("object" == typeof r) {
                    var u = r;
                    r = u.eventName, l = u.params, c = u.delay, u = void 0
                }
                if (!r) return console.error("nge.Lib.Observer error: no eventName. Check your code"), !1;
                if (c) return nge.rafSetTimeout((function() {
                    nge.observer.fire(r, l)
                }), c), !0;
                if (n) return s.push([r, l]), !1;
                if (this.debugFire(r, l), n = !0, i.push(r), c = "_@" + a, (u = function(e, t, n) {
                        if (void 0 !== e[t])
                            for (var i in e[t])(0, e[t][i])(n)
                    })(e, r, l), u(t, r, l), u(e, r += c, l), u(t, r, l), i.pop(), 0 === i.length) {
                    for (var g in n = !1, c = o) u = c[g], this.add(u[0], u[1], u[2], u[3]);
                    o = [], 0 < s.length && (g = s.shift(), this.fire(g[0], g[1]))
                }
                return !0
                ...
                map: function(e, t, n, i) {
                    ...
                    for (o in e)
                        if (!this.isFunction(e[o])) {
                            var a = void 0;
                            void 0 !== t[o] && (a = t[o]), s[o] = n ? this.map(e[o], a, n - 1) : "object"
                        } for (o in t) this.isFunction(t[o]) || void 0 !== s[o] || (s[o] = n ? this.map(void 0, t[o], n - 1) : "object");
                    return i && this.removeUnchanged(s), s
                },
                removeUnchanged: function(e) {
                    for (var t in e) e[t].type === this.VALUE_UNCHANGED ? delete e[t] : "object" == typeof e[t] && (this.removeUnchanged(e[t]), 0 === nge.Lib.Helper.getObjSize(e[t]) && delete e[t])
                },
        ...
        nge.Lib.Tweens = function() {
            ...
            }), this.tweens = e, this.add = function(s) {
                t || (t = !0, nge.observer.add("StatesManager.update.start", g, !1, !0), g()), i++;
                var f = n + "_" + i,
                    p = {
                        id: f,
                        isRunning: !1,
                        ...
                        onComplete: {
                            addOnce: function(e) {
                                p._functions.onComplete.push(e)
                            }
                        },
                        onStart: {
                            addOnce: function(e) {
                                p._functions.onStart.push(e)
                            }
                        },
                        onUpdateCallback: function(e) {
                            p._functions.onUpdate.push(e)
                        }
                    };
                return e[f] = p
            };
            var a = function(e, t, i, o, s) {
                    ...
                    s || (s = 0), this.points.push({
                        ...
                        timeStart: n + s,
                        startDelay: s
                    }), this._complete = !1, o && this.start()
                },
                r = function() {
                    this.isRunning = this._started = !0;
                    for (var e = 0; e < this._functions.onStart.length; e++) this._functions.onStart[e]();
                    0 < this._timeBonus && f(this, !0)
                },
                l = function() {
                    this._paused = !0, this.isRunning = !1, this._pauseTime = n
                },
                c = function() {
                    this.points && this.points[0] && (this.points[0].timeStart += n - this._pauseTime), this._paused = !1, this.isRunning = !0, this._pauseTime = 0
                },
                u = function() {
                    this._complete = !0, this.isRunning = !1, delete e[this.id]
                },
                g = function() {
                    ...
                    for (i in n = t, e) e[i]._complete ? delete e[i] : e[i]._started && !e[i]._paused && f(e[i]);
                    return !0
                },
                f = function(e, t) {
                    var i = e.points[0];
                    if (n < i.timeStart) return !1;
                    for (i = p(e, i, t), t = 0; t < e._functions.onUpdate.length; t++) e._functions.onUpdate[t](e, i);
                    if (1 === i)
                        if (e.points.shift(), 0 === e.points.length) {
                            e._complete = !0, e.isRunning = !1;
                            var o = e._functions.onComplete;
                            for (e._functions.onStart = [], e._functions.onUpdate = [], e._functions.onComplete = [], t = 0; t < o.length; t++) o[t]()
                        } else {
                            for (o in t = n + e.points[0].startDelay, e.points[0].timeStart = n + t, e.points[0].propsTo) e.points[0].propsFrom[o] = e.target[o];
                            t ? nge.setTimeout((function() {
                                f(e)
                            }), t) : f(e)
                        }
                },
        ...
        n(203), n(204), n(205), n(206), n(207), n(208), n(209), n(210), n(211), n(212), n(213), n(214), n(215)
    }, function(e, t) {
        nge.Tpl = {}
    }, function(e, t) {
        nge.Tpl.Groups = {}
