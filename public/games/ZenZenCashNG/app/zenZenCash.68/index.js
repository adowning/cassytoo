...
$jscomp.scope = {}, $jscomp.arrayIteratorImpl = function(t) {
    ...
    function(t) {
        ...
        o.e = function(t) {
            ...
            if (0 !== n)
                if (n) e.push(n[2]);
                    ...
                    s.charset = "utf-8", s.timeout = 120, o.nc && s.setAttribute("nonce", o.nc), s.src = o.p + "games/ZenZenCashNG/app/zenZenCash.68/" + ({
                        0: "game",
                        2: "vendors~vendor"
                    } [t] || t) + ".js";
                    var c = Error(),
        ...
        window.WEBPACK = !0, window.WEBPACK_VERSION = 1, window.GAMECODE = "368", window.MODE = "production", window.JURISDICTION = "other", window.gameVersion = "(build 68 commit b6a449538881a04d453a7fa8e24c70d6c71a8cf3)", window.loadPackedVendorBundles = function() {
